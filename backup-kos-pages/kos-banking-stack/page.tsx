...
import { kaasPublicAPI } from '@/mocks/autoDev10X';
...
export default function bankingStackPage() {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                {data.layer4.patterns.map((pat) => (
                  <div key={pat.pattern} className="rounded-lg bg-background-100 p-3">
                    ...
                    <p className="text-xs font-bold text-foreground-950 mt-1">{pat.equivalent}</p>
