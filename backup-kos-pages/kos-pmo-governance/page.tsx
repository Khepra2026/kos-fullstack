...
export default function pMOGovernancePage() {
  ...
  if (loading) {
    return (
      <hubLayout hubId={68} activeTab="processus" tabLabel="PMO & Gouvernance">
  ...
  return (
    <hubLayout hubId={68} activeTab={activeTab} tabLabel="PMO & Gouvernance">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        {/* Header */}
        <div className="mb-8">
