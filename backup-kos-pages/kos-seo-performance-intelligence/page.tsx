...
export default function seoPerformanceIntelligencePage() {
  ...
  return (
    <hubLayout hubId={99} activeTab={activeTab} tabLabel="SEO Performance Intelligence">
