...
import type { ProceduralKO, FeedbackLoopCycle, ExecutionPattern } from '@/mocks/proceduralKOs';
import type { DecompositionBlueprint, ActiveDecomposition } from '@/mocks/agenticDecomposition';

type ActivePillar = 'pillar2' | 'pillar3';

export default function autoLearningAgenticPage() {
              ...
              <p className="text-xs text-foreground-500">
                {engine.activeCycle?.status === 'running'
                  ...
                  : engine.activeCycle?.status === 'completed'
                    ? `Dernier cycle : ${engine.activeCycle.patternsDetected} patterns → ${engine.activeCycle.generated} KOs`
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1 text-xs text-accent-600">
                    ...
                    <span>KOs: {engine.activeCycle.generated}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {activeTab === 'kos' && (
        <section className="py-6 sm:py-10 bg-background-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Type summary */}
            <div className="flex flex-wrap gap-2 mb-6">
              {Object.entries(engine.byType).map(([type, kos]) => (
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-[10px] text-foreground-400">
                          ...
                          <span>•</span>
                          <span><i className="ri-lightbulb-flash-line mr-1" />{cycle.generated} KOs</span>
                          <span>•</span>
