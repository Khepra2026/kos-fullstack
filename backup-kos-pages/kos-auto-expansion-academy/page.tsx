...
import type { AcademyModule, AcademyLearner, AcademyCertification, AcademyProductionPipeline } from '@/mocks/autoExpansionAcademy';
...
export default function autoExpansionAcademyPage() {
  ...
  return (
    <hubLayout hubId={117} activeTab="Academy" tabLabel="Auto-Expansion Academy™">
      <SeoHead
