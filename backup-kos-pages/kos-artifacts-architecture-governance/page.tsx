...
import { enterpriseArchitectureBlueprints, knowledgeArchitectureComponents, dataGovernanceAssets, aiGovernancePolicies, automationBlueprints } from '@/mocks/artifactsArchitectureGovernance';

type Tab = 'architecture' | 'knowledge' | 'data' | 'ai' | 'automation';

export default function artifactsArchitectureGovernancePage() {
