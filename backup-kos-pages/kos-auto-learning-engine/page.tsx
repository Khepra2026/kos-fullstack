...
import { autoLearningCycles, learningStats, crossDomainLearning, autoCurriculum, selfImprovementLog, learningDomains } from '@/mocks/autoLearningEngine';
import ScrollReveal from '@/components/feature/ScrollReveal';

const tabs = ['Cycles Apprentissage', 'Curriculum Auto', 'Cross-Domain', 'Self-Improvement Log', 'Domaines'];

export default function autoLearningEnginePage() {
