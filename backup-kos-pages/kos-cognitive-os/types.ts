...
export const RegTechResponse = { id: 1, label: "Stub data" }; // stub
export const KPISearch = { id: 1, label: "Stub data" }; // stub

export const ConfidenceScore = { id: 1, label: "Stub data" }; // stub

export const Evidence = { id: 1, label: "Stub data" }; // stub
