...
import { executiveDashboardBlueprints, transformationRoadmap, controlTowerComponents, thinkTankPublications, enterpriseManualBooks } from '@/mocks/artifactsEnterpriseCommand';

type Tab = 'dashboards' | 'roadmap' | 'controltower' | 'thinktank' | 'manual';

export default function artifactsEnterpriseCommandPage() {
