...
const KOSQualityAutoCorrectionPage = lazy(() => import('@/pages/kos-quality-auto-correction/page').then(m => ({ default: m.default })));

// KOS Visibility & Monetization Dashboard
const KOSVisibilityMonetizationPage = lazy(() => import('@/pages/kos-visibility-monetization/page').then(m => ({ default: m.default })));
...
const KOSRegTechAIPage = lazy(() => import('@/pages/kos-regtech-ai/page').then(m => ({ default: m.default })));
// KOS RegTech AI — Historique des pipelines
const KOSRegTechAIHistoryPage = lazy(() => import('@/pages/kos-regtech-ai/history/page').then(m => ({ default: m.default })));
// KOS RegTech AI — Analytics
const KOSRegTechAIAnalyticsPage = lazy(() => import('@/pages/kos-regtech-ai/analytics/page').then(m => ({ default: m.default })));
// KOS RegTech AI — Video Pipeline
const KOSRegTechAIVideoPipelinePage = lazy(() => import('@/pages/kos-regtech-ai/video-pipeline/page').then(m => ({ default: m.default })));
// KOS RegTech AI — Video Preview (Remotion Player + Lecteur)
const KOSRegTechAIVideoPreviewPage = lazy(() => import('@/pages/kos-regtech-ai/video-preview/page').then(m => ({ default: m.default })));
...
export const landingRoutes: RouteObject[] = [
  ...
  // KOS Quality Auto-Correction Dashboard
  { path: '/kos-quality-auto-correction', element: <KOSQualityAutoCorrectionPage /> },
  // KOS Visibility & Monetization Dashboard
  { path: '/kos-visibility-monetization', element: <KOSVisibilityMonetizationPage /> },
  { path: '/kos-visibility-monetization/', element: <KOSVisibilityMonetizationPage /> },
  // Contribution Communautaire — Traduction Langues Africaines
  ...
  { path: '/admin-community-contributions/', element: <AdminCommunityContributionsPage /> },
  // KOS RegTech AI — Pipeline Orchestrator Big Four
  { path: '/kos-regtech-ai', element: <KOSRegTechAIPage /> },
  { path: '/kos-regtech-ai/', element: <KOSRegTechAIPage /> },
  // KOS RegTech AI — Historique des pipelines
  { path: '/kos-regtech-ai/history', element: <KOSRegTechAIHistoryPage /> },
  { path: '/kos-regtech-ai/history/', element: <KOSRegTechAIHistoryPage /> },
  // KOS RegTech AI — Analytics
  { path: '/kos-regtech-ai/analytics', element: <KOSRegTechAIAnalyticsPage /> },
  { path: '/kos-regtech-ai/analytics/', element: <KOSRegTechAIAnalyticsPage /> },
  // KOS RegTech AI — Video Pipeline
  { path: '/kos-regtech-ai/video-pipeline', element: <KOSRegTechAIVideoPipelinePage /> },
  { path: '/kos-regtech-ai/video-pipeline/', element: <KOSRegTechAIVideoPipelinePage /> },
  // KOS RegTech AI — Video Preview (Remotion Player + Lecteur)
  { path: '/kos-regtech-ai/video-preview', element: <KOSRegTechAIVideoPreviewPage /> },
  { path: '/kos-regtech-ai/video-preview/', element: <KOSRegTechAIVideoPreviewPage /> },
