...
export const publicRoutes: RouteObject[] = [
  ...
  { path: '/agents-experts', element: <authGuard><AgentsExpertsPage /></authGuard> },
  ...
  { path: '/advisory-board', element: <authGuard><AdvisoryBoardPage /></authGuard> },
  { path: '/advisory-board/', element: <authGuard><AdvisoryBoardPage /></authGuard> },
  { path: '/audit-final-kos', element: <authGuard><AuditFinalKOSPage /></authGuard> },
  { path: '/revue-conformite-qualite', element: <authGuard><RevueConformiteQualitePage /></authGuard> },
  { path: '/deploiement-final-kos', element: <authGuard><DeploiementFinalKOSPage /></authGuard> },
  ...
  { path: '/rag-synthese', element: <authGuard><RAGSynthesePage /></authGuard> },
  { path: '/mon-abonnement', element: <authGuard><SubscriptionPage /></authGuard> },
  { path: '/centre-editorial', element: <authGuard><EditorialHubPage /></authGuard> },
  { path: '/studio-media', element: <authGuard><StudioMediaPage /></authGuard> },
  { path: '/medias', element: <authGuard><MediasPage /></authGuard> },
  { path: '/medias/', element: <authGuard><MediasPage /></authGuard> },
  ...
  { path: '/visibilite-100', element: <authGuard><Visibilite100Page /></authGuard> },
  { path: '/visibilite-100/', element: <authGuard><Visibilite100Page /></authGuard> },
