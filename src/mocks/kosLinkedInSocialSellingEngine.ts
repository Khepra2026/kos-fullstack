...
export const SOCIAL_SELLING_ARTICLES: SocialSellingArticle[] = [
  // ═══════════ ARTICLE 1 : Guide BCEAO 2026 ═══════════
  {
    ...
    hashtagAudit: {
      ...
      brand: ['#KHEPRAExperts', '#KOSPlatform', '#BigFourStandard', '#GuideBCEAO2026'],
      allHashtags: [
        '#BCEAO', '#UEMOA', '#OHADA',
        '#ConformiteBancaire', '#AuditInterne', '#GestionDesRisques',
        '#BanqueAfrique', '#AgrémentBancaire',
        '#KHEPRAExperts', '#KOSPlatform', '#BigFourStandard', '#GuideBCEAO2026',
      ],
      violations: [],
      score: 100,
    },
  ...
  // ═══════════ ARTICLE 2 : Diagnostic Flash Conformité ═══════════
  {
    ...
    hashtagAudit: {
      ...
      brand: ['#KHEPRAExperts', '#KOSPlatform', '#DiagnosticConformite', '#BigFourStandard'],
      allHashtags: [
        '#BCEAO', '#COBAC', '#UEMOA',
        '#ConformiteReglementaire', '#AuditBancaire', '#RiskManagement',
        '#BanqueAfrique', '#FintechAfrique',
        '#KHEPRAExperts', '#KOSPlatform', '#DiagnosticConformite', '#BigFourStandard',
      ],
      violations: [],
      score: 100,
    },
  ...
  // ═══════════ ARTICLE 3 : Guide Levée de Fonds (BLOQUÉ — Score < 90) ═══════════
  {
    ...
    hashtagAudit: {
      ...
      brand: ['#KHEPRAExperts', '#KOSPlatform', '#GuideLevéeDeFonds'],
      allHashtags: [
        '#UEMOA', '#CEMAC',
        '#LevéeDeFonds', '#PrivateEquity',
        '#StartupAfrique',
        '#KHEPRAExperts', '#KOSPlatform', '#GuideLevéeDeFonds',
      ],
...
export const MASTER_PROMPT_RULES = {
  ...
  hashtags: {
    ...
    examples: ['#BCEAO', '#COBAC', '#OHADA', '#ConformiteBancaire', '#AuditInterne', '#RiskManagement', '#BanqueAfrique', '#FintechAfrique', '#KHEPRAExperts', '#KOSPlatform'],
    weight: 15,
  },
  cta: {
