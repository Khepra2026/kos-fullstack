export interface KOSGapRegister {
  id: number;
  gap_id: string;
...
export interface KOSMigrationLog {
  id: number;
  migration_id: string;
  hook_name: string;
...
export interface KOSComplianceImpact {
  id: number;
  action_id: string;
...
export interface KOSCASSystemHealth {
  total_gaps: number;
...
export const CAS_GAP_REGISTER_MOCK: KOSGapRegister[] = [
  {
...
export const CAS_MIGRATION_LOG_MOCK: KOSMigrationLog[] = [
...
export const CAS_ACTIONS_MOCK: KOSCASAction[] = [
...
export const CAS_COMPLIANCE_IMPACT_MOCK: KOSComplianceImpact[] = [
...
export const CAS_SYSTEM_HEALTH_MOCK: KOSCASSystemHealth = {
  total_gaps: 20,
  gaps_resolved: 4,
  p0_blockers: 2,
  p1_degraded: 8,
