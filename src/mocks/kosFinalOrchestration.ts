...
export const KOS_HUB_REGISTRY: hubRegistryEntry[] = [
  {
    id: 1,
...
export const KOS_UNIFIED_GLOBAL_STATE: unifiedGlobalState = {
  totalHubs: 12,
  nominalHubs: 10,
  degradedHubs: 2,
  criticalHubs: 0,
...
export const KOS_CROSS_SYSTEM_ALERTS: crossSystemAlert[] = [
  {
    id: 'csa-001',
    severity: 'major',
...
export const KOS_SYSTEM_LINKS: systemLink[] = [
...
export const KOS_RESOURCE_ALLOCATIONS: resourceAllocation[] = [
