...
export const integrityByBlock = [
  {
    ...
    issues: [
      ...
      { id: "GOV-002", type: "error", title: "StrategicPlanning : mock data incompatible avec Interface v3", file: "src/mocks/kosStrategicIntelligence.ts", impact: "8 propriétés manquantes — crash si Supabase déconnecté", severity: "high", status: "open", effort: "2h" },
  ...
  },
  {
    ...
    issues: [
      { id: "QAL-001", type: "error", title: "ConsultingFactory : template COBAC utilise circulaire obsolète R-2016/01", file: "src/mocks/kosConsultingMissionFactory.ts", impact: "Non-conformité réglementaire COBAC sur toutes les propositions", severity: "critical", status: "in_progress", effort: "1h30" },
      { id: "QAL-002", type: "bug", title: "ProposalGenerator : TJM 2025 au lieu de 2026 dans 8 templates", file: "src/mocks/kosProposalDrafts.ts (estimé)", impact: "Sous-facturation potentielle de 12%", severity: "high", status: "open", effort: "20 min" },
  ...
  },
  {
    ...
    issues: [
      ...
      { id: "SEC-004", type: "error", title: "RiskEngine : Plan mitigation cyber référence ISO 27001:2013 (obsolète)", file: "src/mocks/kosRiskDiligence.ts", impact: "Audit ISO 27001:2022 échouera sur ce point", severity: "high", status: "open", effort: "1h" },
      { id: "SEC-005", type: "bug", title: "DueDiligenceEngine : Checklist ESG — ISSB S1/S2 manquants", file: "src/mocks/kosRiskDiligence.ts", impact: "Due diligences non conformes ISSB 2026", severity: "high", status: "open", effort: "2h" },
  ...
  },
  {
    ...
    issues: [
      { id: "CSC-001", type: "error", title: "KYC/CDD : Procédure #4 (Personnes Politiquement Exposées) — seuil détection 65% vs 90% GAFI", file: "src/mocks/kosComplianceSecurityCertification.ts", impact: "Risque LCB/FT — non-conformité GAFI Recommandation 12", severity: "critical", status: "open", effort: "3h" },
      { id: "CSC-002", type: "error", title: "LCB/FT : Cartographie CEMAC — score 58/100, gap réglementaire COBAC R-2023/05 non couvert", file: "src/mocks/kosComplianceSecurityCertification.ts", impact: "Risque de sanction COBAC en cas d'inspection", severity: "critical", status: "open", effort: "5h" },
      ...
      { id: "CSC-005", type: "warning", title: "Alignement BCEAO : score 72/100 — 3 gaps non résolus sur les ratios prudentiels", file: "src/mocks/kosComplianceSecurityCertification.ts", impact: "Non-conformité partielle instruction 008-2015", severity: "medium", status: "open", effort: "6h" }
    ]
  },
  {
    ...
    issues: [
      { id: "ESG-001", type: "error", title: "Bilan Carbone : Scope 3 — données transport non actualisées depuis Q1 2026", file: "src/mocks/kosESGSustainabilityCommand.ts", impact: "Sous-estimation Scope 3 de 18%", severity: "high", status: "open", effort: "3h" },
      { id: "ESG-002", type: "error", title: "EcoVadis : Domaine Achats Responsables — score 30/68, 4 preuves manquantes sur 10", file: "src/mocks/kosESGSustainabilityCommand.ts", impact: "Score EcoVadis plafonné à Argent (42) au lieu de Gold (75)", severity: "high", status: "open", effort: "5h" },
  ...
  },
  {
    ...
    issues: [
      ...
      { id: "ARC-003", type: "warning", title: "3 fichiers > 1000 lignes (kosDigitalPerformanceCommand.ts: 1144, page.tsx: 1062, kosGlobalAgentScanAgents.ts: 500+)", file: "src/mocks/ + src/pages/", impact: "Maintenabilité dégradée, risque de régression", severity: "medium", status: "open", effort: "8h" },
...
export const architectureIssues = {
  ...
  findings: [
    ...
    { id: "ARC-002", type: "circular_dep", title: "useKOSNotifications.ts ⇄ KOSNotificationBell.tsx", severity: "low", impact: "Code splitting inefficace", recommendation: "Utiliser un contexte React pour découpler" },
    { id: "ARC-003", type: "dead_file", title: "src/mocks/kosLegacyDashboard.ts — non importé depuis 4 versions", severity: "low", impact: "Bundle gonflé de 45 KB inutiles", recommendation: "Supprimer ou archiver" },
    ...
    { id: "ARC-008", type: "oversized", title: "kosDigitalPerformanceCommand.ts : 1144 lignes", severity: "medium", impact: "Maintenabilité — risque régression élevé", recommendation: "Splitter en 3 fichiers : cwv.ts, owasp.ts, soc2.ts" },
    { id: "ARC-009", type: "oversized", title: "kosDigitalPerformanceCommand/page.tsx : 1062 lignes", severity: "medium", impact: "Temps de compilation +40% sur ce fichier", recommendation: "Splitter en sous-composants par onglet" },
