...
export interface KOSBlockFamily {
  id: string;
  name: string;
  icon: string;
  color: string;
...
export interface KOSBlockExecutionGlobal {
...
export interface KOSBlockExecutionPhase {
  phase_number: number;
  label: string;
  icon: string;
  families: string[];
...
export interface KOSBlockExecutionLog {
  id: string;
  timestamp: string;
  agent_name: string;
  family_name: string;
...
export const KOS_BLOCK_FAMILIES: KOSBlockFamily[] = [
  {
    id: 'fullstack-dev',
    name: 'Fullstack Dev',
...
export const KOS_BLOCK_EXECUTION_GLOBAL: KOSBlockExecutionGlobal = {
  total_families: 13,
  total_agents: 333,
  deployed_before: 232,
  deployed_target: 333,
...
export const KOS_BLOCK_EXECUTION_PHASES: KOSBlockExecutionPhase[] = [
  {
    phase_number: 1,
...
export const KOS_BLOCK_EXECUTION_LOGS: KOSBlockExecutionLog[] = [];