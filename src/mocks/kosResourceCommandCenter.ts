...
export interface KOSEngineResource {
  id: string;
  name: string;
  path: string;
  icon: string;
...
export interface KOSUnifiedAgent {
  id: string;
  name: string;
  engine: string;
  engineName: string;
...
export interface KOSSystemHealth {
  generatedAt: string;
  totalAgents: number;
  activeAgents: number;
  partialAgents: number;
...
// 8 KOS ENGINES
// ============================================================
export const KOS_ENGINES: KOSEngineResource[] = [
  {
...
// ============================================================
export const KOS_UNIFIED_AGENTS: KOSUnifiedAgent[] = [
...
// ============================================================
export const SYSTEM_HEALTH: KOSSystemHealth = {
