...
export interface KOSFamilySync {
  id: string;
  name: string;
  icon: string;
  color: string;
...
export interface KOSMasterGlobalKPIs {
...
export interface KOSKPODimension {
  id: string;
  name: string;
  icon: string;
  color: string;
...
export interface KOSGapAnalysis {
  family_id: string;
  family_name: string;
...
export interface KOSMasterSyncLog {
  id: string;
  agent_name: string;
  family_name: string;
  action: string;
...
export interface KOSDeploymentPlan {
  phase: string;
  label: string;
  families: string[];
  target_date: string;
...
export const KOS_MASTER_FAMILIES: KOSFamilySync[] = [
  {
...
export const KOS_MASTER_GLOBAL_KPIS: KOSMasterGlobalKPIs = {
  total_families: 13,
  total_agents: 333,
  deployed: 333,
  partial: 0,
...
export const KOS_KPO_DIMENSIONS: KOSKPODimension[] = [
  {
    id: 'kpo-deployment',
    name: 'Déploiement',
...
export const KOS_GAP_ANALYSIS: KOSGapAnalysis[] = [
  {
...
export const KOS_MASTER_SYNC_LOGS: KOSMasterSyncLog[] = [
...
export const KOS_DEPLOYMENT_PLAN: KOSDeploymentPlan[] = [
  {
    phase: 'phase-1',
