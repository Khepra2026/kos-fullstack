...
export const TEST_BLOCS: TestBloc[] = [
  ...
  // ============================================================
  {
    ...
    findings: [
      ...
      { id: 'HM-004', severity: 'medium', title: '2 systèmes de navigation parallèles — Navbar + Sidebar en conflit', description: 'Certaines pages affichent les deux simultanément, d\'autres un seul. Pas de règle documentée.', location: 'hubLayout + Navigation.tsx', detectedDate: '2026-06-17', autoFixable: false, status: 'open' },
    ],
    correctifs: [
