...
export const phase3Chantiers = [
  ...
  },
  {
    ...
    description: "Résolution des 4 imports circulaires détectés par le scan d'architecture : useManagingPartnerOffice.ts ⇄ useStrategicPlanning.ts, useKOSNotifications.ts ⇄ KOSNotificationBell.tsx, useProposalDrafts.ts ⇄ ProposalCreateModal.tsx, useControlTowerData.ts ⇄ ControlTowerDashboard.tsx. Élimination des 7 fichiers morts (kosLegacyDashboard.ts, oldImageOptimizer.ts, 5 fichiers de test). Extraction de la logique partagée dans des fichiers séparés pour découpler les dépendances.",
    actions: [
      ...
      { id: "P3Q-003-A3", action: "Supprimer 7 fichiers morts (kosLegacyDashboard.ts, oldImageOptimizer.ts, 5 fichiers test)", status: "open", owner: "Lead Dev Frontend", effort: "30 min" },
