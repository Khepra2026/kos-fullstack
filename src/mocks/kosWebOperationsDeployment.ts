export interface KOSDeploymentEngine {
  id: string;
  name: string;
  shortName: string;
  description: string;
...
export interface KOSComplianceStandard {
  id: string;
  name: string;
  description: string;
  icon: string;
...
export interface KOSQualityGate {
  id: string;
  name: string;
  description: string;
  icon: string;
...
export interface KOSDeploymentPipeline {
  stage: number;
  name: string;
  description: string;
...
export const KOS_ENGINES_DEPLOYED: KOSDeploymentEngine[] = [
  {
    id: 'quality-system',
...
export const KOS_COMPLIANCE_STANDARDS: KOSComplianceStandard[] = [
  {
    id: 'big-four-quality',
...
export const KOS_QUALITY_GATES: KOSQualityGate[] = [
  {
    id: 'gate-content',
...
export const KOS_DEPLOYMENT_PIPELINE: KOSDeploymentPipeline[] = [
  {
