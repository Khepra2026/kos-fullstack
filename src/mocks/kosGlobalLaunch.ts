...
export interface KOSGlobalBlock {
  id: string;
  name: string;
  icon: string;
  color: string;
...
export interface KOSGlobalTask {
  id: string;
  title: string;
...
export interface KOSGlobalLaunchStats {
  total_blocks: number;
  total_tasks: number;
...
export const KOS_GLOBAL_BLOCKS: KOSGlobalBlock[] = [
  // ============================================================
...
export function computeGlobalStats(blocks: KOSGlobalBlock[]): KOSGlobalLaunchStats {
  return {
...
export interface KOSGlobalLaunchLog {
  id: string;
  timestamp: string;
  block_name: string;
  task_title: string;
...
export const KOS_GLOBAL_LAUNCH_LOGS: KOSGlobalLaunchLog[] = [
