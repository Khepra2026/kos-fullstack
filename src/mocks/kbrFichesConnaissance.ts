...
export const FCK_005_SCIENTIFIC_DIRECTOR = {
  ...
  metaKOS: {
    ...
    dependances: ['kosScientificDirector.ts', 'kbrFichesConnaissance.ts', 'kosScientificIntelligenceEnhancement.ts'],
    prochaineRevision: '2026-09-27',
  },
};
...
export const FCK_006_GROWTH_COMMERCIAL_STRATEGY = {
  ...
  metaKOS: {
    ...
    dependances: ['kosGrowthCommercialStrategy.ts', 'kbrFichesConnaissance.ts', 'kosClosingGrowthEngine.ts', 'kosKhepraGrowthEngine.ts'],
    prochaineRevision: '2026-09-27',
  },
};