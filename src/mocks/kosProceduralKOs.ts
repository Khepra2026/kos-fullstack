...
export const feedbackLoopStats = {
  ...
  topAgentSources: [
    { agent: 'KOS Regulatory Scout', kosGenerated: 15 },
    { agent: 'KOS Orchestrator Engine', kosGenerated: 12 },
    { agent: 'KOS Content Publication Gate', kosGenerated: 10 },
    { agent: 'KOS Lead Scoring Engine', kosGenerated: 8 },
    { agent: 'KOS LLM Content Generator', kosGenerated: 7 },
  ],
};