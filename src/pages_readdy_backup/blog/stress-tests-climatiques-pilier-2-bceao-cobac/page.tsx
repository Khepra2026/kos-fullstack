...
const article = ARTICLES_GENERATED.find(a => a.id === 'stress-tests-climatiques-pilier-2-2026');
...
export default function ArticleStressTestsClimatiques() {
  ...
  return (
    <>
      <SeoHead
        ...
        ogType="article"
        articlePublishedTime="2026-06-23T08:00:00+00:00"
        articleAuthor="Pr. Moussa Traoré"
        articleSection="Risques Climatiques & Supervision"
      ...
      <main className="min-h-screen bg-background-50">
          ...
          <div className="h-[420px] md:h-[540px] w-full bg-cover bg-top relative" style={{ backgroundImage: `url(${article.hero_image_url})` }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 text-sm font-bold uppercase tracking-wider" style={{ background: 'rgba(220,38,38,0.2)', border: '1px solid rgba(220,38,38,0.4)', color: '#DC2626' }}>
                  <i className="ri-temp-hot-line" /> {article.category}
                </div>
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 py-12">
          ...
          <section className="mb-10">
            <div className="p-6 md:p-8 rounded-2xl border-2 border-primary-500/30 bg-gradient-to-br from-background-50 to-red-500/5">
