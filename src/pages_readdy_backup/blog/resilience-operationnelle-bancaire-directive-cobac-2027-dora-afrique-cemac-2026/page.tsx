...
const article = ARTICLES_GENERATED.find(a => a.id === 'resilience-operationnelle-cobac-dora-2026');
...
export default function ArticleResilienceCOBAC() {
  ...
  return (
    <>
      <SeoHead
        ...
        ogType="article"
        articlePublishedTime="2026-06-22T10:00:00+00:00"
        articleAuthor="Dr. Simda Padagnassou"
        articleSection="Résilience Opérationnelle & Cybersécurité CEMAC"
      ...
      <main className="min-h-screen bg-background-50">
          ...
          <div className="h-[420px] md:h-[540px] w-full bg-cover bg-top relative" style={{ backgroundImage: `url(${article.hero_image_url})` }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 text-sm font-bold uppercase tracking-wider" style={{ background: 'rgba(8,145,178,0.2)', border: '1px solid rgba(8,145,178,0.4)', color: '#0891B2' }}>
                  <i className="ri-shield-flash-line" /> {article.category}
                </div>
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 py-12">
          ...
          <section className="mb-10">
            <div className="p-6 md:p-8 rounded-2xl border-2 border-primary-500/30 bg-gradient-to-br from-background-50 to-cyan-500/5">
          ...
          <section className="mb-10">
            <div className="p-6 md:p-8 rounded-2xl bg-foreground-950 text-background-50">
              <div className="flex items-center gap-3 mb-4">
                <i className="ri-file-text-line text-2xl text-primary-500" />
          ...
          <div className="p-8 md:p-10 rounded-3xl text-center bg-foreground-950">
            ...
            <Link to={article.cta.action_url} className="inline-flex items-center gap-2 px-8 py-3 rounded-full font-bold text-foreground-950 bg-primary-500 hover:bg-primary-600 transition-colors whitespace-nowrap cursor-pointer">
          ...
          <div className="mt-8 p-5 rounded-2xl bg-background-100 border border-background-200">
            <p className="text-foreground-600 text-xs leading-relaxed">
              <strong>Avertissement :</strong> Cet article est fourni à titre d'analyse et d'information. La directive COBAC citée est en projet — les textes définitifs devront être consultés dans leur version officielle publiée. Les données empiriques sont issues de notre recherche sur 31 banques CEMAC. Les résultats peuvent varier selon le contexte spécifique de chaque institution. Khepra Experts ne saurait être tenu responsable des décisions prises sur la seule base de cette analyse. Information non vérifiée à ce stade pour certains points prospectifs.
            </p>
          </div>
        </div>
      </main>
