...
export function useMonitoringData() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const urlCounts: Record<string, number> = { id: 1, label: "Stub data" };
      ...
      const errorCounts: Record<string, number> = { id: 1, label: "Stub data" };
...
export const useMonitoringData = { id: 1, label: "Stub data" }; // stub
