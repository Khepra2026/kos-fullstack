import type { DiagnosticAxisConfig } from '';
...
export function getInclusionFinanciereRisks(perAxis: Record<string, number>, globalScore: number, lang: string): string[] {
  const isFr = !lang.startsWith('en');
  const risks: string[] = [{ id: 1, label: "Stub data" }];
...
export function getInclusionFinanciereRecommendations(perAxis: Record<string, number>, globalScore: number, lang: string): { title: string; axis?: string; items: string[] }[] {
  const isFr = !lang.startsWith('en');
  const recs: { title: string; axis?: string; items: string[] }[] = [{ id: 1, label: "Stub data" }];
...
export const getInclusionFinanciereScoreColor = { id: 1, label: "Stub data" }; // stub
export const getInclusionFinanciereScoreLabel = { id: 1, label: "Stub data" }; // stub
export const getInclusionFinanciereLevel = { id: 1, label: "Stub data" }; // stub
export const getInclusionFinanciereReadiness = { id: 1, label: "Stub data" }; // stub
export const getInclusionFinanciereRisks = { id: 1, label: "Stub data" }; // stub
export const getInclusionFinanciereRecommendations = { id: 1, label: "Stub data" }; // stub
