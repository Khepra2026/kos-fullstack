...
import { INCLUSION_FINANCIERE_AXES, getInclusionFinanciereScoreColor, getInclusionFinanciereScoreLabel, getInclusionFinanciereLevel, getInclusionFinanciereReadiness, getInclusionFinanciereRisks, getInclusionFinanciereRecommendations } from '';
