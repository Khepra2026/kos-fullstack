...
import type { organisationQualiteAutomate } from '@/hooks/useOrganisationQualiteAutomates';
...
export default function organisationQualiteAutomatesPage() {
            ...
            <>
              ...
              {filteredAutomates.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                  {filteredAutomates.map((automate: organisationQualiteAutomate) => {
