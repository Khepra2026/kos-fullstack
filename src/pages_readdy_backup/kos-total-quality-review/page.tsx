...
export default function totalQualityReviewPage() {
  ...
  return (
    <hubLayout hubId={121} activeTab="Qualité Totale" tabLabel="Total Quality Review & Auto-Healing Auto-Expansion">
      <SeoHead
