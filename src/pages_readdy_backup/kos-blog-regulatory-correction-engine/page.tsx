...
import PatternsPanel from '';
import ArticleScoresPanel from '';
import CorrectionQueuePanel from '';
import KnowledgeRulesPanel from '';
import CorrectionHistoryPanel from '';
...
export default function blogRegulatoryCorrectionPage() {
    ...
    return (
      <>
        <SeoHead
          ...
          noIndex={true}
        />
        <hubLayout hubId={64} activeTab="Blog Correction" tabLabel="Blog Correction Engine">
