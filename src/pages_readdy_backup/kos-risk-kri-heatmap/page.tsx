...
import { riskKriHeatmap } from '@/mocks/riskKriHeatmap';

export default function riskKriHeatmapPage() {
  ...
  return (
    <hubLayout hubId="kos-risk-kri-heatmap" title={d.title} subtitle={d.subtitle}>
