...
import type { regulatoryComplianceAutomate } from '@/hooks/useRegulatoryComplianceAutomates';
...
export default function regulatoryComplianceAutomatesPage() {
            ...
            <>
              ...
              {filteredAutomates.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                  {filteredAutomates.map((automate: regulatoryComplianceAutomate) => {
