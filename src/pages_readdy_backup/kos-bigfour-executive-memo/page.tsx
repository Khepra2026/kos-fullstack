...
import { bigFourMemoMockHistory, bigFourMemoQuickQueries } from '@/mocks/bigFourExecutiveMemo';
import { PDFDownloadLink, BlobProvider } from '@react-pdf/renderer';
import { memoPDFDocument } from '@/pages/kos-bigfour-executive-memo/components/memoPDFDocument';
...
export default function bigFourExecutiveMemoPage() {
  const [activeTab, setActiveTab] = useState<Tab>('generate');
  const [query, setQuery] = useState('');
  const [isGenerating, setIsGenerating] = useState(false);
  const [currentMemo, setCurrentMemo] = useState<Memo | null>(null);
  const [history, setHistory] = useState<Memo[]>(bigFourMemoMockHistory as Memo[]);
            ...
            <div className="space-y-8">
              ...
              <div className="bg-background-50 border border-background-200/70 rounded-xl p-6">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  ...
                  {bigFourMemoQuickQueries.slice(0, 6).map((q) => (
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-background-50 border border-background-200/70 rounded-xl p-5">
                    <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
                      <div className="flex items-center gap-3">
                        ...
                        <PDFDownloadLink
                          document={<memoPDFDocument memo={currentMemo} />}
                  ...
                  {showPdfPreview && (
                    <div className="bg-background-50 border border-background-200/70 rounded-xl overflow-hidden">
                      ...
                      <BlobProvider document={<memoPDFDocument memo={currentMemo} />}>
