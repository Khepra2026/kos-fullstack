...
import type { ProcessMappingEntry, RegionalComplianceRequirement, AIFraudDetectionModule, InfrastructureMetric, Phase1CorrectiveAction, ComplianceKPI } from '@/mocks/phase1FoundationsCompliance';
...
export default function phase1FoundationsCompliancePage() {
