...
import type { automateFamily, unifiedGlobalKPIs } from '@/hooks/useKOSCommandementOperationnel';
...
export default function commandementOperationnelUnifiePage() {
  ...
  const domainFamilies = useMemo(() => {
    const map: Record<string, automateFamily[]> = {};
    families.forEach(f => {
            ...
            <>
              ...
              {filteredFamilies.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                  {filteredFamilies.map((family: automateFamily) => {
