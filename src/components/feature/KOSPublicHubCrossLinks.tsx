...
interface KOSPublicHubCrossLinksProps {
  currentPage: 'observatoire' | 'agrements' | 'compliance-factory' | 'compliance-score' | 'hub-national' | 'observatoire-pme';
}

const ALL_LINKS: Record<KOSPublicHubCrossLinksProps['currentPage'], CrossLink[]> = {
  observatoire: [
...
export default function KOSPublicHubCrossLinks({ currentPage }: KOSPublicHubCrossLinksProps) {
