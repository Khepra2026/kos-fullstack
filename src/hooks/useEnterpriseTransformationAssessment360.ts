...
import {
  ...
  ASSESSMENT_META,
} from '@/mocks/kosEnterpriseTransformationAssessment360';
import type { AuditAxe, AuditRiskItem, AuditRoadmapPhase } from '@/mocks/kosEnterpriseTransformationAssessment360';
