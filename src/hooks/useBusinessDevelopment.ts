...
import { PIPELINE_STAGES, LEAD_SOURCES, BD_AGENTS, BD_GLOBAL_METRICS, type PipelineStage, type LeadSource, type BDAgent } from '@/mocks/kosBloc11BusinessDevelopment';
