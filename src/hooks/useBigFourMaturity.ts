...
import type { DomainAssessment, CorrectiveAction, RiskMatrixItem, RoadmapPhase, ReadinessReport } from '@/mocks/kosBigFourMaturityAssessment';
import {
...
} from '@/mocks/kosBigFourMaturityAssessment';
