...
import { getSSEBigFourContentItems, getSSEReadyCount } from '@/utils/kosSSEToBigFourFactory';
import { KHEPRA_VOICE_PROFILES, VOICE_PROFILES } from '@/mocks/kosVoiceAIStudio';
import { supabase } from '@/lib/supabase';
import { contentToPublishingPack, shouldTriggerPublishingPack } from '@/utils/kosBigFourToPublishingPack';
import type { PublishingPack } from '@/mocks/kosVideoPodcastPublishingPack';

export interface KOSHybridYoutubeStudioData {
...
export function useKOSHybridYoutubeStudio(): KOSHybridYoutubeStudioData {
