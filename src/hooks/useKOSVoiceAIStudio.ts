...
import { VOICE_PROFILES, KHEPRA_VOICE_PROFILES, type VoiceProfile } from '@/mocks/kosVoiceAIStudio';
...
export interface KOSVoiceAIStudioData {
  // Profiles
...
export function useKOSVoiceAIStudio(): KOSVoiceAIStudioData {
