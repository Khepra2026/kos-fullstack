...
import { KOS_ORGANISATION_QUALITE_AUTOMATES as mockAutomates, ORGANISATION_QUALITE_CATEGORIES as mockCategories, ORGANISATION_QUALITE_KPIS as mockKPIs } from '@/mocks/kosOrganisationQualiteAutomates';
import type { KOSOrganisationQualiteAutomate, OrganisationQualiteCategory } from '@/mocks/kosOrganisationQualiteAutomates';

export type { KOSOrganisationQualiteAutomate, OrganisationQualiteCategory };
...
export interface OrganisationQualiteData {
  automates: KOSOrganisationQualiteAutomate[];
  categories: OrganisationQualiteCategory[];
  kpis: OrganisationQualiteKPIs;
  isLive: boolean;
}

function mapAutomate(row: Record<string, unknown>): KOSOrganisationQualiteAutomate {
  return {
    id: row.id as string,
    ...
    status: row.status as KOSOrganisationQualiteAutomate['status'],
    ...
    priority: row.priority as KOSOrganisationQualiteAutomate['priority'],
    kpis: Array.isArray(row.kpis) ? row.kpis as KOSOrganisationQualiteAutomate['kpis'] : [],
