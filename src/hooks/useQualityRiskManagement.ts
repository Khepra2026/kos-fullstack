...
import { QUALITY_CONTROLS, QUALITY_AGENTS, AUDIT_LOGS, QUALITY_GLOBAL_METRICS, type QualityControl, type QualityAgent, type AuditLog } from '@/mocks/kosBloc12QualityRisk';
