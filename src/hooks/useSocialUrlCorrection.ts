...
import { scanSocialUrls, autoCorrectUrl, type SocialUrlCorrectionScan, type UrlHealthReport, type AutoCorrectionResult } from '@/mocks/kosSocialUrlCorrectionEngine';
