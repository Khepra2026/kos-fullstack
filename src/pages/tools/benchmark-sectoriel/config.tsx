...
import { BENCHMARK_SECTORIEL_AXES, getBenchmarkSectorielScoreColor, getBenchmarkSectorielScoreLabel, getBenchmarkSectorielLevel, getBenchmarkSectorielReadiness, getBenchmarkSectorielRisks, getBenchmarkSectorielRecommendations } from './data';
