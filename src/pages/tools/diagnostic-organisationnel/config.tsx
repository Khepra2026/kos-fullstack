...
import { DIAG_ORG_AXES, getDiagOrgScoreColor, getDiagOrgScoreLabel, getDiagOrgLevel, getDiagOrgReadiness, getDiagOrgRisks, getDiagOrgRecommendations } from './data';
