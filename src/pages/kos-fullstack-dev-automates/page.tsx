...
import type { KOSDevAutomate } from '@/hooks/useFullstackDevAutomates';
...
export default function KOSFullstackDevAutomatesPage() {
            ...
            <>
              ...
              {filteredAutomates.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                  {filteredAutomates.map((automate: KOSDevAutomate) => {
