...
import {
  ...
  type DiffusionPlan,
} from '@/mocks/kosInstitutionalVisibility';
...
export default function KOSInstitutionalVisibilityPage() {
  const {
    organizations,
    decisionMakers,
    projects,
  ...
  if (loading) {
    return (
      <KOSHubLayout hubId={61} activeTab="a1" tabLabel="Institutional Visibility">
  ...
  return (
    <KOSHubLayout hubId={61} activeTab={activeTab} tabLabel={tabs.find(t => t.id === activeTab)?.label}>
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        {/* Header */}
        <div className="mb-8">
