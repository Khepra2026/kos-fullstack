...
import type { KOSFamilySync, KOSKPODimension, KOSGapAnalysis, KOSDeploymentPlan } from '@/hooks/useKOSMasterSynchronizer';
...
export default function KOSMasterSynchronizerPage() {
