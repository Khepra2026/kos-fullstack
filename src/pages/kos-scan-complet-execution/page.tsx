...
import type { ScanDomain, ScanRemainingTask, ScanExecutionBlock, ScanGlobalStats } from '@/mocks/kosScanCompletExecution';
...
export default function KOSScanCompletExecutionPage() {
  ...
  return (
    <KOSHubLayout hubId={999} activeTab="dashboard" tabLabel="Scan Complet + Exécution">
      <SeoHead
