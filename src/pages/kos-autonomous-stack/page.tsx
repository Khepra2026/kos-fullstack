...
import type { ExternalDependency, MigrationTask } from '@/mocks/kosAutonomousStack';
...
export default function KOSAutonomousStackPage() {
  const [activeTab, setActiveTab] = useState<TabId>('diagnostic');
  const engine = useKOSAutonomousStack();
  const stats = engine.getStats();

  return (
    <KOSHubLayout hubId={91} activeTab="Autonomous Stack" tabLabel="Autonomous Stack Transformation">
      <main>
        {/* Hero */}
