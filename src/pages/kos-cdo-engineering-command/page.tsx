...
import {
  ...
  executiveSummary,
  cdoKpiSnapshot,
} from '@/mocks/kosCDOEngineeringCommand';
...
export default function KOSCDOEngineeringCommandPage() {
  ...
  return (
    <>
      <SeoHead
        ...
        noIndex={true}
      />
      <KOSHubLayout hubId={72} activeTab="cockpit" tabLabel="CDO & Growth Engineering">
