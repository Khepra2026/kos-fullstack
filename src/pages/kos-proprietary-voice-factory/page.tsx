...
import type { PronunciationDictionary, ScriptTemplate, VoiceEngineOption, AudioQAResult } from '@/mocks/kosProprietaryVoiceFactory';
...
export default function KOSProprietaryVoiceFactoryPage() {
  const [activeTab, setActiveTab] = useState<TabId>('identity');
  const factory = useKOSProprietaryVoiceFactory();
  const stats = factory.getStats();

  return (
    <KOSHubLayout hubId={90} activeTab="Voice Factory" tabLabel="Proprietary Voice Factory">
      <main>
        {/* Hero */}
