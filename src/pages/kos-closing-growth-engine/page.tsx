...
import type { LeadMagnetRecommendation, ClosingAlert, EvolutionMutation, VisitorProfile } from '@/mocks/kosClosingGrowthEngine';
...
export default function KOSClosingGrowthEnginePage() {
  const engine = useKOSClosingGrowthEngine();
  const [activeTab, setActiveTab] = useState('overview');

  return (
    <KOSHubLayout hubId={118} activeTab={activeTab} tabLabel={TABS.find((t) => t.id === activeTab)?.label}>
      {/* Header */}
