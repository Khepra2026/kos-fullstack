...
import type { BlocScanModule, Finding } from '@/mocks/kosBlocTotalCompliance';
import type { BigFourExecutiveReport, RegulatoryCoverageGap, AutoHealingAction, BigFourRecommendation, KOSAutomatonState, HyperionState, HyperionTickResult, HyperionDevResult, ChampionState, UltimateIntegrationState, UltimateIntegrationResult } from '@/hooks/useKOSBlocTotalCompliance';
...
export default function KOSBlocTotalCompliancePage() {
