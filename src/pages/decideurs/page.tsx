...
import DecideursHero from './components/DecideursHero';
import DecideursProfiles from './components/DecideursProfiles';
import DecideursCTA from './components/DecideursCTA';
