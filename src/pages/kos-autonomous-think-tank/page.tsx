...
import { thinkTankStatus, researchPrograms, recentPublications, strategicForesight, thinkTankKPIs } from '@/mocks/kosAutonomousThinkTank';
import ScrollReveal from '@/components/feature/ScrollReveal';

const tabs = ['Programmes Recherche', 'Publications', 'Prospective', 'KPIs'];

export default function KOSAutonomousThinkTankPage() {
