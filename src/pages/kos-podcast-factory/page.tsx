...
import type { PodcastScript, ProductionVariant } from '@/mocks/kosPodcastFactory';
...
export default function KOSPodcastFactoryPage() {
  const [activeTab, setActiveTab] = useState<TabId>('subjects');
  const engine = useKOSPodcastFactory();
  const stats = engine.getStats();

  return (
    <KOSHubLayout hubId={93} activeTab="Podcast-Factory" tabLabel="KOS Podcast Factory">
      <main>
        {/* Hero */}
