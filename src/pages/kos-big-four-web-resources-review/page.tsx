...
import type { AuditNonConformite, AuditRisque, AuditCorrection, AuditAutoapprentissage, AuditDomainSummary } from '@/mocks/kosBigFourWebResourcesAudit';
...
export default function KOSBigFourWebResourcesReviewPage() {
  ...
  if (loading) {
    return (
      <>
        ...
        <KOSHubLayout hubId={65} activeTab="Big Four Review" tabLabel="Big Four Web Review">
