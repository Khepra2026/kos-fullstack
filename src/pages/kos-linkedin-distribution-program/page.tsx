...
import { LINKEDIN_DISTRIBUTION_PROGRAM, DISTRIBUTION_SCHEDULE_DAYS, type LinkedInPostDraft } from '@/mocks/kosLinkedInDistributionProgram';
...
export default function KOSLinkedInDistributionProgram() {
