...
import {
  ...
  KOS_OVERALL_HEALTH,
} from '@/mocks/kosWebOperationsDeployment';
import type { KOSDeploymentEngine, KOSQualityGate } from '@/mocks/kosWebOperationsDeployment';
...
function getGateStatusBadge(gate: KOSQualityGate) {
...
export default function KOSWebOperationsDeploymentPage() {
