...
import type { LanguageSEOStats, AcademicPublication, MediaPartnership, AIPlatformVisibility, MonthlyVisibilityObjective, MonthlyVisibilityKPI } from '@/mocks/kosGlobalVisibilityCommand';
