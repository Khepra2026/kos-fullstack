...
import KOSRegTechDashboard from '@/components/feature/KOSRegTechDashboard';
import { KOSToasterProvider, useToast } from '@/components/feature/KOSToaster';
...
export default function KOSRegTechAIPage() {
  return (
    <KOSToasterProvider>
