...
import { AGENT_CATALOG } from '@/mocks/kosAgentBlockScanner';
import type { BlockScanResult, BlockDetection } from '@/mocks/kosAgentBlockScanner';
...
export default function KOSAgentBlockUpdatesPage() {
