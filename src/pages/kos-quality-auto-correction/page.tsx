...
export default function KOSQualityDashboardPage() {
  const [activeTab, setActiveTab] = useState<string>('overview');

  return (
    <KOSHubLayout hubId={127}>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg p-6 border border-background-200/70">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2 text-foreground-700"><i className="ri-checkbox-circle-line text-primary-500" /> src/__tests__/kosQualityEngine.test.ts — 20 tests (Quality Scoring, Publication Gate, ISO 27001, Hook Pattern)</div>
