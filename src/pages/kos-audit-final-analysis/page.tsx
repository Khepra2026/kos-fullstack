...
import { AUDIT_FINAL_META, ROADMAP_PRIORITAIRE } from '@/mocks/kosAuditFinalAnalysis';
...
export default function KOSAuditFinalAnalysisPage() {
  const {
  ...
  return (
    <KOSHubLayout hubId={210} activeTab="dashboard" tabLabel="Audit Final Analysis">
