...
import { marketingAutopilotStatus, activeCampaigns, contentAutoProduction, seoAutopilotMetrics, socialAutoMetrics, emailNurturingStats } from '@/mocks/kosAutonomousDigitalMarketing';
import ScrollReveal from '@/components/feature/ScrollReveal';

const tabs = ['Campagnes', 'Production Contenu', 'SEO Autopilot', 'Réseaux Sociaux', 'Email Nurturing'];

export default function KOSAutonomousDigitalMarketingPage() {
