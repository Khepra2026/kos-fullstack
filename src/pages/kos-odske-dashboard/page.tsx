...
import type { ODSKEMetric, ODSKESourceRegistry } from '@/mocks/kosOdskeDashboard';
...
export default function KosOdskeDashboardPage() {
  ...
  return (
    <KOSHubLayout hubId={150} title="ODSKE Governance Dashboard">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 space-y-6">
        <KOSHubSwitcher currentHubId={150} activeTab={TABS.find(t => t.key === tab)?.label || ''} />
