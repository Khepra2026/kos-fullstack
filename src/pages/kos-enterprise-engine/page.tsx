...
import {
  ...
  KPI_SCORECARD,
  GLOBAL_AUDIT_RESULT,
} from '@/mocks/kosEnterpriseEngine';
import type { EnterpriseAuditCategory, ExecutionBatch } from '@/mocks/kosEnterpriseEngine';
...
import type { ControlTowerKPI } from '@/mocks/kosControlTowerAutomationFactory';
...
export default function KOSEnterpriseEnginePage() {
