...
import { enterpriseArchitectureSystems, digitalTwinSimulations, aiGovernanceAgents, enterpriseSecurityDomains, advisoryBoardMembers, scientificCommitteeMembers, specializedCommittees, governanceKPIs } from '@/mocks/kosEnterpriseGovernance';

type Tab = 'architecture' | 'digitaltwin' | 'aigovernance' | 'security' | 'advisory' | 'scientific' | 'committees';

export default function KOSEnterpriseGovernanceCommandPage() {
