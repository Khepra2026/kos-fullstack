...
import type { TestBloc, TestFinding, CorrectifAction } from '@/mocks/kosTestsParBloc';
...
export default function KOSTestsParBlocPage() {
  const {
  ...
  if (loading) {
    return (
      <KOSHubLayout hubId={0} activeTab="overview" tabLabel="Tests par Bloc">
  ...
  return (
    <KOSHubLayout hubId={0} activeTab={activeTab} tabLabel="Tests par Bloc">
