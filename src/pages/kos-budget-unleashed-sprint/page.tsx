...
import type { BudgetUnleashedAction } from '@/mocks/kosBudgetUnleashedSprint';
import { BUDGET_UNLEASHED_ACTIONS } from '@/mocks/kosBudgetUnleashedSprint';
...
export default function KOSBudgetUnleashedSprintPage() {
  const {
    actions,
    kpis,
    meta,
