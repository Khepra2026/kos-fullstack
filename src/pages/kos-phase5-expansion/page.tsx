...
export default function KosPhase5ExpansionPage() {
  ...
  const data = usePhase5Expansion();

  const handleLaunchPhase5 = () => {
    setToast('Phase 5 activée — EXPANSION PANAFRICAINE ! 8 chantiers, objectif : Score d\'Excellence 105/105. KOS rayonne sur tout le continent.');
    setTimeout(() => setToast(null), 5000);
  };

  return (
    <KOSHubLayout hubId={104}>
      <SeoHead
        title="KOS Phase 5 Expansion & Rayonnement™ — SLA, Expansion CEMAC, Partenariats, SEO, Revenue Ops | KHEPRA EXPERTS"
        description="Phase 5 du Plan Consolidation — EXPANSION : SLA 99.9%, onboarding industrialisé, expansion CEMAC+Anglophone+Lusophone, activation écosystème partenaires, fine-tuning IA, SEO/Content ×2, Revenue Operations. Objectif : Score d'Excellence 100→105. Panafricain."
        keywords="KOS Phase 5, expansion, CEMAC, partenariats, SEO, revenue operations, KHEPRA EXPERTS, Big Four, 105/105, panafricain"
        canonicalPath="/kos-phase5-expansion"
      />

      {/* Hero */}
      <section className="relative overflow-hidden bg-background-50 border-b border-background-200">
        <div className="absolute inset-0 opacity-[0.04]">
          <img src="https://readdy.ai/api/search-image?query=stunning%20aerial%20view%20of%20African%20continent%20from%20space%20at%20dawn%20with%20golden%20light%20spreading%20across%20the%20landmass%20glowing%20network%20nodes%20lighting%20up%20major%20cities%20from%20Dakar%20to%20Lagos%20to%20Douala%20to%20Luanda%20interconnected%20digital%20pathways%20flowing%20like%20rivers%20of%20light%20between%20financial%20hubs%20elegant%20corporate%20aesthetic%20with%20deep%20violet%20and%20gold%20gradients%20pristine%20atmosphere&width=1920&height=600&seq=kos-phase5-hero-x1&orientation=landscape" alt="" className="w-full h-full object-cover object-center" width="1920" height="600" />
        </div>
        <div className="absolute inset-0 bg-gradient-to-b from-purple-950/80 via-foreground-950/90 to-foreground-950" />

        <div className="max-w-7xl mx-auto px-4 md:px-6 py-14 md:py-18 relative z-10">
          <ScrollReveal>
            <Breadcrumb items={[{ label: 'Accueil', href: '/' }, { label: 'Phase 4 Go-Live', href: '/kos-phase4-go-live' }, { label: 'Phase 5 Expansion', href: '/kos-phase5-expansion' }]} />
            <div className="mt-6 flex flex-col lg:flex-row items-start gap-8">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-5 flex-wrap">
                  <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-purple-600 border border-purple-500">
                    <span className="w-2 h-2 rounded-full bg-white animate-pulse" />
                    <span className="text-xs font-bold text-white">PHASE 5 ACTIVE — EXPANSION & RAYONNEMENT</span>
                  </span>
                  <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-amber-500/20 border border-amber-400/30 text-sm text-amber-300 font-bold whitespace-nowrap">
                    <i className="ri-global-line text-sm" /> PANAFRICAIN
                  </span>
                  <span className="text-xs text-foreground-400">{data.daysRemaining} jours restants · Deadline 5 Septembre</span>
                </div>
                <h1 className="text-3xl md:text-5xl font-bold text-white leading-tight">
                  Phase 5 : Expansion & Rayonnement
                </h1>
                <p className="mt-4 text-lg text-gray-300 max-w-2xl">
                  Faire de KOS la plateforme de référence panafricaine : <strong className="text-white">SLA 99.9%, onboarding industrialisé, expansion CEMAC + Nigéria + Angola, écosystème 60 partenaires, fine-tuning IA, SEO ×2, Revenue Operations</strong>. KOS rayonne sur tout le continent.
                </p>
                <p className="mt-2 text-sm text-gray-400">Objectif : Score d'Excellence <strong className="text-purple-400">100 → 105</strong> le 5 Septembre 2026 · Budget : 28,5M FCFA · <strong className="text-purple-300">KOS devient panafricain</strong></p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 flex-shrink-0">
                {[
                  { label: 'Progression', value: `${data.globalProgress}%`, icon: 'ri-timer-line', color: 'text-purple-400' },
                  { label: 'En Cours', value: `${data.inProgressChantiers}`, icon: 'ri-loader-4-line', color: 'text-amber-400' },
                  { label: 'Ouverts', value: `${data.openChantiers}`, icon: 'ri-global-line', color: 'text-secondary-400' },
                  { label: 'Actions', value: `${data.completedActions}/${data.totalActions}`, icon: 'ri-check-double-line', color: 'text-purple-400' },
                ].map((s) => (
            ...
            <div className="flex flex-wrap gap-3 mt-8">
              <button onClick={handleLaunchPhase5} className="flex items-center gap-2 px-5 py-3 rounded-full bg-purple-600 hover:bg-purple-700 text-white text-sm font-bold transition-all cursor-pointer whitespace-nowrap">
                <i className="ri-global-line" />
                Lancer l'Expansion — Phase 5
              </button>
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/20 border border-purple-400/30 text-sm text-purple-300 font-bold whitespace-nowrap">
                Score cible : {data.phase5Stats.target_score}/105
              </span>
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/20 border border-amber-400/30 text-sm text-amber-300 whitespace-nowrap">
                Budget : {data.phase5Budget.total}
              </span>
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/20 border border-purple-400/30 text-sm text-purple-300 whitespace-nowrap">
                <i className="ri-earth-line text-sm" /> UEMOA · CEMAC · Nigéria · Angola
              </span>
            </div>
          </ScrollReveal>
        </div>
      ...
      <section className="bg-purple-950 border-t border-purple-800">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            ...
            <div className="flex-1">
              <p className="text-xs text-purple-300 font-semibold uppercase tracking-wider">Commander's Intent — Phase 5 Expansion</p>
              <p className="text-sm text-purple-100 mt-0.5">{data.phase5Stats.commander_intent}</p>
            </div>
            <div className="flex-shrink-0 text-right">
              <p className="text-lg font-bold text-white">{data.globalProgress}%</p>
              <p className="text-[10px] text-purple-300">Progression Globale</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {toast && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in fade-in slide-in-from-bottom-4">
          <div className="bg-purple-600 text-white px-5 py-3 rounded-xl shadow-2xl flex items-center gap-3">
...
// TAB 1 : COCKPIT
// ================================================================
function CockpitTab({ data }: { data: ReturnType<typeof usePhase5Expansion> }) {
  return (
    <div className="space-y-10">
      <ScrollReveal>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-background-50 border border-background-200 rounded-xl p-6">
            <h3 className="text-xs font-bold text-foreground-400 uppercase tracking-wider mb-4">Progression Phase 5 — Rayonnement Panafricain</h3>
            <div className="flex items-center gap-5">
              <div className="relative w-28 h-28 flex-shrink-0">
                <svg className="w-28 h-28 transform -rotate-90" viewBox="0 0 112 112">
                  ...
                  <circle cx="56" cy="56" r="48" fill="none" stroke="oklch(0.25 0.12 300)" strokeWidth="10" strokeLinecap="round"
              ...
              <div className="flex-1 space-y-3">
                <div className="flex justify-between text-xs">
                  <span className="text-foreground-500">Score Phase 4</span>
                  <span className="font-bold text-foreground-800">{data.phase5Stats.starting_score}/105</span>
                </div>
                <div className="flex justify-between text-xs">
                  <span className="text-foreground-500">Score cible Excellence</span>
                  <span className="font-bold text-purple-600">{data.phase5Stats.target_score}/105</span>
                </div>
                <div className="flex justify-between text-xs">
          ...
          <div className="lg:col-span-2 bg-background-50 border border-background-200 rounded-xl p-6">
            <h3 className="text-xs font-bold text-foreground-400 uppercase tracking-wider mb-4">Statut des 8 Chantiers d'Expansion</h3>
            <div className="space-y-2.5">
              {data.phase5Chantiers.map((c) => (
      ...
      <ScrollReveal>
        <div className="bg-background-50 border border-background-200 rounded-xl p-6">
          <h3 className="text-sm font-bold text-foreground-950 mb-4 flex items-center gap-2">
            <i className="ri-line-chart-line text-purple-600" /> Trajectoire Complète — Plan Consolidation 76→105
          </h3>
          <div className="flex items-center gap-0 w-full overflow-x-auto pb-2">
            {[
              ...
              { label: 'Phase 5', score: 105, date: '5 Sept', color: 'bg-purple-500' },
            ].map((step, i, arr) => (
      ...
      <ScrollReveal>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
          {[
            { label: 'Chantiers Ouverts', value: `${data.openChantiers}/8`, icon: 'ri-global-line', color: 'text-secondary-600', bg: 'bg-secondary-50 border-secondary-200' },
            ...
            { label: 'Actions OK', value: `${data.completedActions}/${data.totalActions}`, icon: 'ri-check-double-line', color: 'text-purple-600', bg: 'bg-purple-50 border-purple-200' },
            ...
            { label: 'Budget Restant', value: data.phase5Budget.remaining, icon: 'ri-money-dollar-circle-line', color: 'text-purple-600', bg: 'bg-purple-50 border-purple-200' },
          ].map((s) => (
      ...
      <ScrollReveal>
        <div className="bg-purple-50/30 border border-purple-200 rounded-xl p-6">
          <h3 className="text-sm font-bold text-purple-800 mb-3 flex items-center gap-2">
            <i className="ri-global-line" /> Commander's Intent — Phase 5 Expansion
          </h3>
          <p className="text-sm text-purple-700 leading-relaxed">{data.phase5Stats.commander_intent}</p>
        </div>
      </ScrollReveal>
    </div>
  );
...
// ================================================================
// TAB 2 : 8 CHANTIERS EXPANSION
// ================================================================
function ChantiersTab({ data, expandedChantier, setExpandedChantier }: {
  data: ReturnType<typeof usePhase5Expansion>;
  ...
  const categColors: Record<string, string> = {
    ...
    'Partenariats': 'bg-amber-100 text-amber-700',
    ...
    <div className="space-y-6">
      <ScrollReveal>
        <div className="flex items-center gap-4 flex-wrap">
          <h2 className="text-xl font-bold text-foreground-950">8 Chantiers d'Expansion — Détail par Action</h2>
      ...
      {data.phase5Chantiers.map((chantier) => {
        ...
        return (
          <ScrollReveal key={chantier.id}>
            <div className={`rounded-2xl border-2 transition-all ${chantier.severity === 'critical' ? 'border-red-200 bg-red-50/10' : 'border-purple-200 bg-purple-50/10'}`}>
              <button onClick={() => setExpandedChantier(isExpanded ? null : chantier.id)}
                ...
                <div className="flex-shrink-0 text-right">
                  <div className={`text-2xl font-bold ${chantier.progress >= 50 ? 'text-purple-600' : chantier.progress >= 25 ? 'text-amber-600' : chantier.progress === 0 ? 'text-foreground-300' : 'text-red-600'}`}>
                    {chantier.progress}%
                  </div>
...
// TAB 3 : TIMELINE
// ================================================================
function TimelineTab({ data }: { data: ReturnType<typeof usePhase5Expansion> }) {
  const tl = data.phase5Timeline;

  return (
    <div className="space-y-8">
      <ScrollReveal>
        <h2 className="text-xl font-bold text-foreground-950 mb-1">Timeline — 2 Semaines d'Expansion Panafricaine</h2>
        <p className="text-sm text-foreground-500">{tl.start} → {tl.end} · {data.daysRemaining} jours restants · Score 100 → 105</p>
      </ScrollReveal>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {tl.weeks.map((week, wi) => (
          <ScrollReveal key={wi}>
            <div className={`rounded-xl border-2 p-6 ${wi === 0 ? 'border-purple-200 bg-purple-50/10' : 'border-amber-200 bg-amber-50/10'}`}>
              <div className="flex items-center gap-3 mb-5">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center text-lg font-bold ${wi === 0 ? 'bg-purple-100 text-purple-700' : 'bg-amber-100 text-amber-700'}`}>
                  {week.week}
                </div>
                <div>
      ...
      <ScrollReveal>
        <div className="bg-background-50 border border-background-200 rounded-xl p-6">
          <h3 className="text-sm font-bold text-foreground-950 mb-4">Deadlines par Chantier — Expansion</h3>
      ...
      <ScrollReveal>
        <div className="bg-purple-600 rounded-xl p-8 text-center">
          <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-white/20 flex items-center justify-center">
            <i className="ri-global-line text-white text-3xl" />
          </div>
          <h3 className="text-2xl font-bold text-white mb-2">5 SEPTEMBRE 2026 — KOS PANAFRICAIN</h3>
          <p className="text-purple-100 text-sm">Score d'Excellence 105/105 · UEMOA · CEMAC · Nigéria · Angola · 60 Partenaires · 60 Articles/Mois</p>
        </div>
      </ScrollReveal>
    </div>
  );
...
// TAB 4 : BUDGET
// ================================================================
function BudgetTab({ data }: { data: ReturnType<typeof usePhase5Expansion> }) {
  const b = data.phase5Budget;

  return (
    <div className="space-y-8">
      <ScrollReveal>
        <h2 className="text-xl font-bold text-foreground-950 mb-1">Budget Phase 5 — Financement de l'Expansion</h2>
        <p className="text-sm text-foreground-500">Budget total : {b.total} · Dépensé : {b.spent} · Restant : {b.remaining} · Budget Plan Consolidation + Expansion cumulé : ~135,1M FCFA</p>
      </ScrollReveal>

      <ScrollReveal>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-background-50 border border-background-200 rounded-xl p-5 text-center">
            <p className="text-[10px] text-foreground-400 uppercase tracking-wider mb-2">Budget Total Phase 5</p>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-xl p-5 text-center">
            <p className="text-[10px] text-purple-500 uppercase tracking-wider mb-2">Budget Restant</p>
            <p className="text-2xl font-bold text-purple-700">{b.remaining}</p>
          </div>
        </div>
      </ScrollReveal>
          ...
          <table className="w-full text-xs">
            ...
            <tbody>
              ...
              <tr className="border-t-2 border-foreground-200">
                <td className="py-2.5 font-bold text-foreground-950">TOTAL PHASE 5</td>
      ...
      <ScrollReveal>
        <div className="bg-purple-50/20 border border-purple-200 rounded-xl p-6">
          <h3 className="text-sm font-bold text-purple-800 mb-3">Budget Cumulé — Plan Consolidation + Expansion</h3>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {[
              ...
              <div key={p.phase} className="p-3 rounded-xl bg-white/50 border border-purple-100 text-center">
                <p className="text-[9px] text-purple-600 font-semibold">{p.phase}</p>
                <p className="text-sm font-bold text-purple-900 mt-1">{p.amount}</p>
              </div>
            ))}
            <div className="md:col-span-5 p-3 rounded-xl bg-purple-100 border border-purple-300 text-center mt-2">
              <p className="text-xs font-bold text-purple-800">TOTAL PLAN CONSOLIDATION + EXPANSION : ~135 100 000 FCFA — 5 phases, 10 semaines, 39 chantiers, 178 actions</p>
            </div>
          </div>
        </div>
      </ScrollReveal>
...
// TAB 5 : DÉPENDANCES
// ================================================================
function DependancesTab({ data }: { data: ReturnType<typeof usePhase5Expansion> }) {
  return (
    <div className="space-y-8">
      <ScrollReveal>
        <h2 className="text-xl font-bold text-foreground-950 mb-1">Graphe de Dépendances — Phase 5</h2>
        <p className="text-sm text-foreground-500">10 dépendances critiques — P5E-001 (SLA Monitoring) est la clé de voûte</p>
      </ScrollReveal>
      ...
      <ScrollReveal>
        <div className="bg-background-50 border border-background-200 rounded-xl p-6">
          ...
          <div className="space-y-4">
            {data.phase5Dependencies.map((dep, i) => (
      ...
      <ScrollReveal>
        <div className="bg-purple-50/20 border border-purple-200 rounded-xl p-6">
          <h3 className="text-sm font-bold text-purple-800 mb-4 flex items-center gap-2">
            <i className="ri-git-branch-line" /> Chemin Critique — P5E-001, la fondation de l'expansion
          </h3>
          <p className="text-xs text-purple-700 mb-4">
            <strong>P5E-001 (SLA 99.9%)</strong> est la fondation — il alimente l'onboarding (P5E-002), le fine-tuning IA (P5E-006) et l'expansion CEMAC (P5E-003). Sans SLA solide, toute l'expansion s'effondre.
          </p>
          <div className="flex flex-wrap items-center gap-2 text-xs">
            <span className="px-3 py-2 rounded-full bg-cyan-100 text-cyan-800 font-bold text-sm">P5E-001 SLA</span>
            <i className="ri-arrow-right-line text-purple-400" />
            <span className="px-3 py-2 rounded-full bg-emerald-100 text-emerald-800 font-bold">P5E-002 Onboarding</span>
            <i className="ri-arrow-right-line text-purple-400" />
            <span className="px-3 py-2 rounded-full bg-red-100 text-red-800 font-bold">P5E-003 CEMAC</span>
            <i className="ri-arrow-right-line text-purple-400" />
            <span className="px-3 py-2 rounded-full bg-purple-100 text-purple-800 font-bold text-sm">P5E-008 Revenue</span>
          </div>
        </div>
      </ScrollReveal>
    </div>
...
// ================================================================
function ExecutionLogTab({ data }: { data: ReturnType<typeof usePhase5Expansion> }) {
  ...
  return (
    <div className="space-y-6">
      <ScrollReveal>
        <h2 className="text-xl font-bold text-foreground-950 mb-1">Journal d'Exécution — Phase 5 Expansion</h2>
        <p className="text-sm text-foreground-500">Lancé le {data.phase5Stats.launched_at.split('T')[0]} à {data.phase5Stats.launched_at.split('T')[1].slice(0, 5)} · Rayonnement panafricain</p>
      </ScrollReveal>

      <div className="relative">
        <div className="absolute left-5 top-0 bottom-0 w-0.5 bg-background-200" />
        <div className="space-y-4">
          {data.phase5ExecutionLog.map((entry, i) => {
      ...
      <ScrollReveal>
        <div className="bg-purple-50/20 border border-purple-200 rounded-xl p-6 text-center">
          <h3 className="text-sm font-bold text-purple-800 mb-2 flex items-center justify-center gap-2">
            <i className="ri-global-line" /> Expansion en Cours
          </h3>
          <p className="text-2xl font-bold text-purple-700">{data.daysRemaining} JOURS</p>
          <p className="text-xs text-purple-600 mt-1">avant le Rayonnement Panafricain — 5 Septembre 2026</p>
        </div>
      </ScrollReveal>
    </div>
  );
