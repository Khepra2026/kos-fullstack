...
import type { KOSGapRegister, KOSCASAction, KOSMigrationLog } from '@/mocks/kosCasData';
...
function GapCard({ gap }: { gap: KOSGapRegister }) {
...
function ActionRow({ action }: { action: KOSCASAction }) {
...
function MigrationRow({ m }: { m: KOSMigrationLog }) {
...
export default function KosCorrectiveSystemDashboardPage() {
  ...
  return (
    <KOSHubLayout hubId={155} title="KOS Corrective Action System">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 space-y-6">
        <KOSHubSwitcher currentHubId={155} activeTab={TABS.find(t => t.key === tab)?.label || ''} />
