...
import HeroUltraLeadMagnet from './components/HeroUltraLeadMagnet';
import HomeRAGSearch from './components/HomeRAGSearch';
...
const KOSAIChatSection = lazy(() => import('./components/KOSAIChatSection'));
