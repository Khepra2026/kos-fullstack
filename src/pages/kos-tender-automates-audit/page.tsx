...
} from '@/mocks/kosTenderAutomatesAudit';

type DetailTab = 'overview' | 'tools' | 'skills' | 'gaps' | 'notifications';

export default function KOSTenderAutomatesAuditPage() {
  ...
  return (
    <KOSHubLayout hubId={51} activeTab="overview" tabLabel="Audit Automates AO/AMI">
      {/* ===== HERO ===== */}
