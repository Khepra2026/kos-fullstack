...
import RAGOrchestratorPanel from './components/RAGOrchestratorPanel';
...
export default function KOSKnowledgeCenterPage() {
  const {
    knowledgeGuides,
    knowledgeTemplates,
    knowledgeChecklists,
  ...
  return (
    <KOSHubLayout hubId={53} activeTab={activeTab} tabLabel={tabs.find(t => t.id === activeTab)?.label}>
      {/* Header */}
