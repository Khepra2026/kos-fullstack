...
import {
  ...
  planActionCorrectif,
  validatorKPIs,
} from '@/mocks/kosRegulatoryCitationValidator';
import type { ValidatedCitation, FichierAuditResult } from '@/mocks/kosRegulatoryCitationValidator';
...
export default function KOSRegulatoryCitationValidatorPage() {
  ...
  return (
    <KOSHubLayout hubId={120}>
      <KOSHubSwitcher currentHubId={120} activeTab={activeTab} tabLabel={TABS.find(t => t.id === activeTab)?.label || ''} />
