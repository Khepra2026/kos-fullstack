...
import type { KOSAgent, KOSDetectedError, KOSCorrectiveAction } from '@/mocks/kosQualitySystem';
...
export default function KOSAutonomousQualitySystemPage() {
  ...
  const allErrors = useMemo(() => {
    const errors: (KOSDetectedError & { agentName: string; agentColor: string })[] = [];
  ...
  const allActions = useMemo(() => {
    const actions: (KOSCorrectiveAction & { agentName: string; agentColor: string })[] = [];
    agents.forEach((agent) => {
