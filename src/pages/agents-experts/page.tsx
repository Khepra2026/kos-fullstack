...
import { newGrowthAgents } from './data/kosGrowthAgents';
import {
  kosPhases,
  architectureLayers,
  responseSteps,
  ...
  vision2030,
  kosConstitutionPreamble,
  kosConstitutionArticles,
  kosConstitutionOath,
  kosConstitutionStatut,
} from './data/kosPhases';
import {
  governanceOrgans,
  governanceCharterArticles,
  governanceCharterIntro,
} from './data/kosGovernanceCharter';
import {
  ...
  recommendedStack,
  blueprintIntro,
} from './data/kosArchitectureBlueprint';
import {
...
} from './data/kosDataGovernanceRAG';
import {
  runtimeIntro,
...
} from './data/kosSEOAutopilotEngine';
import {
  seoV2Intro,
  seoV2CoreEngine,
  seoV2BacklinkEngine,
...
import {
  ...
  saasModules,
  backlinkConclusion,
} from './data/kosBacklinkAutomationSystem';
import {
  webOpsIntro,
  webOpsObjectives,
  webOpsModules,
...
} from './data/kosAutoHealingSystem';
import {
  blockUpdateIntro,
  blockTypes,
  bigFourKpiTargets,
...
} from './data/kosBlockUpdateEngine';
import {
  devOpsIntro,
  pipelineSteps,
  intelligenceLayers,
...
import {
  ...
  sreConclusion,
  sreUltraMode,
} from './data/kosSREDashboardEngine';
import {
  digitalComIntro,
  ...
  digitalComUltraMode,
} from './data/kosDigitalComSocialAudit';
import { SocialMetricsLiveBanner } from './components/SocialMetricsLiveBanner';
import {
  linkedInAPIIntro,
  linkedInAPILayers,
  linkedInAPIKPIs,
  ...
  quickStatusCards,
} from './data/kosLinkedInAPIIntegration';
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto mb-14">
              <div className="rounded-3xl border-2 border-amber-300 bg-gradient-to-br from-amber-50/80 to-white p-8 sm:p-10 text-center relative overflow-hidden">
                ...
                <p className="text-base text-foreground-700 leading-relaxed max-w-3xl mx-auto italic">{kosConstitutionPreamble}</p>
              </div>
            </div>

            {/* Articles Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {kosConstitutionArticles.map((article, i) => (
                <div
                  key={article.num}
            ...
            <div className="max-w-2xl mx-auto mt-10">
              <div className="rounded-2xl border border-background-200 bg-background-100 p-6 text-center">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-100 border border-amber-200 mb-4">
                  ...
                  <span className="text-xs font-bold text-amber-700 uppercase tracking-wider">{kosConstitutionStatut.label}</span>
                </div>
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                  <div>
                    <p className="text-xs text-foreground-400 mb-0.5">Autorité</p>
                    <p className="text-sm font-semibold text-foreground-800">{kosConstitutionStatut.authority}</p>
                  </div>
                  <div>
                    <p className="text-xs text-foreground-400 mb-0.5">Portée</p>
                    <p className="text-sm font-semibold text-foreground-800">{kosConstitutionStatut.scope}</p>
                  </div>
                  <div>
                    <p className="text-xs text-foreground-400 mb-0.5">Version</p>
                    <p className="text-sm font-semibold text-foreground-800">{kosConstitutionStatut.version}</p>
                  </div>
                  <div>
                    <p className="text-xs text-foreground-400 mb-0.5">Niveau</p>
                    <p className="text-sm font-semibold text-foreground-800">{kosConstitutionStatut.level}</p>
                  </div>
                </div>
              </div>
            </div>
