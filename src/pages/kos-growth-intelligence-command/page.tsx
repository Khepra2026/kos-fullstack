...
import { proposalIntelligenceMock, clientHealthMock, reputationAuthorityMock } from '@/mocks/kosGrowthIntelligence';

type Tab = 'proposals' | 'clients' | 'reputation';

export default function KOSGrowthIntelligenceCommandPage() {
