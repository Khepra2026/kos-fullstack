...
} from '@/mocks/kosRegulatoryIntelligenceCenter';
import type { RegulatoryAlert, Synthese, ImpactAnalysis, ComplianceMatrix, RegulatoryKPI } from '@/mocks/kosRegulatoryIntelligenceCenter';
...
export default function KOSRegulatoryIntelligenceCenterPage() {
