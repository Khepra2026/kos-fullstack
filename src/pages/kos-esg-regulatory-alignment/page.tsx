...
import type { ESGGovernanceAssessment, AMLCFTRequirement, AuditCommitteeSetup, ISO27001Control, CorrectiveAction } from '@/mocks/kosESGRegulatoryAlignment';
