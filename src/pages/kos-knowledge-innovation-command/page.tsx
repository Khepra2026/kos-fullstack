...
import { knowledgeMonetizationAssets, serviceInnovations, trainingModules } from '@/mocks/kosKnowledgeInnovation';

type Tab = 'monetization' | 'innovation' | 'academy';

export default function KOSKnowledgeInnovationCommandPage() {
