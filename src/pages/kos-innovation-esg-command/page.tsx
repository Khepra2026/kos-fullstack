...
import { esgDashboardKPIs, innovationDashboardKPIs, methodologyDashboardKPIs } from '@/mocks/kosInnovationESG';
...
export default function KOSInnovationESGCommandPage() {
