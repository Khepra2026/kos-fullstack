...
import { useKOSPhase1P0Immediate, type P0VueActive, type KOSAction } from '@/hooks/useKOSPhase1P0Immediate';
...
export default function KOSPhase1P0ImmediatePage() {
  const {
  ...
  if (loading) {
    return (
      <KOSHubLayout hubId={211} activeTab="dashboard" tabLabel="Phase 1 P0 Immediate">
