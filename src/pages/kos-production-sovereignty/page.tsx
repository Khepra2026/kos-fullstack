...
import type { ProductionWorkstream, SovereigntyAction, SovereigntyMilestone } from '@/mocks/kosProductionSovereignty';
import { PRODUCTION_SOVEREIGNTY_META, PRODUCTION_TIMELINE, PRODUCTION_WORKSTREAMS, PRODUCTION_EXECUTIVE_SUMMARY } from '@/mocks/kosProductionSovereignty';
...
export default function KOSProductionSovereigntyPage() {
  const {
  ...
  return (
    <KOSHubLayout hubId={200} activeTab="dashboard" tabLabel="Production Sovereignty">
