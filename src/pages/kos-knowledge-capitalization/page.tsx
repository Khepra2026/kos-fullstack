...
export default function KosKnowledgeCapitalizationPage() {
  ...
  if (loading) {
    return (
      <KOSHubLayout title="Knowledge Capitalization Hub">
  ...
  return (
    <KOSHubLayout title="KOS Knowledge Capitalization Hub™" subtitle="Capitalisation documentaire — 26 BLOCs · 67+ documents métier · Patrimoine intellectuel KHEPRA">
      <style>{`
        @keyframes fadeInUp {
