...
import BigFourEvidenceTab from './components/BigFourEvidenceTab';
import KPITowerTab from './components/KPITowerTab';
...
export default function KOSUltimateCockpitPage() {
  const [activeTab, setActiveTab] = useState<TabId>('overview');
  const ctx = useKOSUltimateCockpit();

  return (
    <KOSHubLayout hubId={101} activeTab="Ultimate Cockpit" tabLabel="Ultimate Cockpit™">
      <main>
        {/* ── HERO BAR ── */}
