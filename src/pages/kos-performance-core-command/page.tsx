...
import { performanceExcellenceMetrics, selfImprovementPlans, executiveCommandCenter } from '@/mocks/kosPerformanceCore';

type Tab = 'performance' | 'selfimprovement' | 'commandcenter';

export default function KOSPerformanceCoreCommandPage() {
