...
import type { BuildRecord, PipelineStage, QualityGate, DeploymentRecord, PostDeployReport } from '@/mocks/kosDeploymentPipeline';
...
export default function KOSDeploymentPipelinePage() {
  ...
  return (
    <KOSHubLayout hubId={65} activeTab={activeTab} tabLabel={activeTabData?.label}>
      <SeoHead
