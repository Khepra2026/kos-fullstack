...
import { royaltyEngine } from '@/mocks/kosAutoDev10X';
import { bigFourMasterPrompts } from '@/mocks/kosBigFourMasterPrompts';
...
export default function KOSAIGovernanceEthicsPage() {
  const {
    registry: aiRegistry,
