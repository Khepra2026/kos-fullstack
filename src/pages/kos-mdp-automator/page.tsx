...
import {
  ...
  MDP_AGENTS,
  MDP_AUTOMATOR_STATS,
} from '@/mocks/kosMDPAutomator';
import type { MDPChecklistStep, MDPFormField, MDPVideoScriptStep, MDPAgentTier } from '@/mocks/kosMDPAutomator';
...
export default function KOSMDPAutomatorPage() {
