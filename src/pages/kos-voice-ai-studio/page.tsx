...
import { VOICE_PROFILES, GENERATED_VOICES, STUDIO_STATS, PENDING_SCRIPTS, type VoiceProfile, type GeneratedVoice } from '@/mocks/kosVoiceAIStudio';
...
export default function KOSVoiceAIStudioPage() {
