...
import type { CentreExcellence } from '@/mocks/kosDigitalAuthorityEngine';
...
export default function KOSDigitalAuthorityEnginePage() {
  ...
  if (loading) {
    return (
      <KOSHubLayout hubId={81} activeTab="dashboard" tabLabel="Digital Authority">
  ...
  return (
    <KOSHubLayout hubId={81} activeTab={activeTab} tabLabel={tabs.find(t => t.id === activeTab)?.label}>
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        {/* Header */}
        <div className="mb-8">
