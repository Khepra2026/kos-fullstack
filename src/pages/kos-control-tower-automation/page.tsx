...
import { executiveCockpitScores, cockpitThresholds, cockpitOverallMetrics, type ExecutiveCockpitScore } from '@/mocks/kosControlTowerAutomation';

type Tab = 'tower' | 'automation' | 'resources' | 'capacity' | 'forecasting' | 'scenarios' | 'cockpit';

export default function KOSControlTowerAutomationPage() {
