...
import type { DecisionLog } from '@/mocks/kosSelfEvolution';
...
export default function KOSSelfEvolutionPage() {
  const [activeTab, setActiveTab] = useState<TabId>('decision');
  const engine = useKOSSelfEvolution();
  const stats = engine.getStats();

  return (
    <KOSHubLayout hubId={89} activeTab="Self-Evolution" tabLabel="Programme Auto-Évolution">
      <main>
        {/* Hero */}
