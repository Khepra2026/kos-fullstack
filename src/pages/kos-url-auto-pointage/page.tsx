...
export default function KOSUrlAutoPointagePage() {
  ...
  return (
    <>
      <SeoHead
        ...
        noIndex={true}
      />
      <KOSHubLayout hubId={49} activeTab="Auto-Pointage" tabLabel="URL Auto-Pointage">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-xl font-semibold text-foreground-950">
                      {t('kosUrlAutoPointage.title') || 'URL Auto-Pointage'}
                    </h1>
                    <p className="text-sm text-foreground-600">
                      {t('kosUrlAutoPointage.subtitle') || 'Surveillance automatique de toutes les URLs sur khepraexperts.com'}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-accent-100 text-accent-900">
                    ...
                    {t('kosUrlAutoPointage.cron') || 'Cron quotidien 04h00'}
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-primary-100 text-primary-900">
                    ...
                    {t('kosUrlAutoPointage.sitemapMode') || 'Auto-decouverte sitemap'}
                  </span>
                </div>
              </div>
            </div>
