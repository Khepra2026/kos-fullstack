...
} from '@/mocks/kosResearchInstitute';
...
export default function KOSResearchInstitutePage() {
  ...
  return (
    <KOSHubLayout hubId={51} activeTab={activeTab} tabLabel={tabs.find(t => t.id === activeTab)?.label}>
      {/* Header */}
