...
import { regulatoryWatchStatus, monitoredRegulators, activeRegulatoryAlerts, ragAutoUpdateLog, regulatoryCoverageMatrix } from '@/mocks/kosAutonomousRegulatoryWatch';
import ScrollReveal from '@/components/feature/ScrollReveal';

const tabs = ['Alertes Actives', 'Régulateurs', 'Couverture', 'RAG Auto-Update'];

export default function KOSAutonomousRegulatoryWatchPage() {
