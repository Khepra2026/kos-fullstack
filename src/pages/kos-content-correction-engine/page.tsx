...
import { grammaticalReviewStats, grammaticalIssues, reviewAgents, GrammaticalIssue } from '@/mocks/kosGrammaticalReview';
...
export default function KOSContentCorrectionEnginePage() {
