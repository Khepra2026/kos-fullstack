...
import type { CorrectionFixPattern, MemorizationScan, AutoFixEvent } from '@/mocks/kosMemorization';
...
export default function KOSAutoMemorizationPage() {
  ...
  return (
    <KOSHubLayout hubId={95} activeTab="Auto-Memorization" tabLabel="Auto-Apprentissage & Mémorisation">
      <SeoHead
