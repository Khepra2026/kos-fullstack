...
import type { AgentPool, RACIEntry, Workflow, Escalade, RegleValidation } from '@/mocks/kosMultiAgentOrchestration';
...
export default function KOSMultiAgentOrchestrationPage() {
