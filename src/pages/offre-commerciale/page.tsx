...
import OffreHero from './components/OffreHero';
import OffreProbleme from './components/OffreProbleme';
import OffreSolution from './components/OffreSolution';
import OffreDiagnostic from './components/OffreDiagnostic';
import OffreServices from './components/OffreServices';
import OffrePourquoi from './components/OffrePourquoi';
import OffreResultats from './components/OffreResultats';
import OffreCTA from './components/OffreCTA';
import OffreSocialShare from './components/OffreSocialShare';
import OffreMethodology from './components/OffreMethodology';
