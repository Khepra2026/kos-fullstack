...
import PerformanceFixPanel from './components/PerformanceFixPanel';
import SEOFixPanel from './components/SEOFixPanel';
import AssetsFixPanel from './components/AssetsFixPanel';
import SecurityFixPanel from './components/SecurityFixPanel';
import AccessibilityFixPanel from './components/AccessibilityFixPanel';
...
export default function KOSCorrectionEnginePage() {
    ...
    return (
      <>
        <SeoHead
          ...
          noIndex={true}
        />
        <KOSHubLayout hubId={58} activeTab="Correction Engine" tabLabel="Correction Engine">
