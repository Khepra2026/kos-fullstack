...
import { iso27001Compliance, nistCSFProfile, socOperations, enterpriseSecurityStats } from "@/mocks/kosEnterpriseSecurityFull";
import KOSHubLayout from '@/components/feature/KOSHubLayout';

export default function KOSSecurityCommandPage() {
