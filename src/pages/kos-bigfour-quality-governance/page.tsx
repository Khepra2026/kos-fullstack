...
} from '@/mocks/kosBigFourQualityGovernance';
...
import { shadowAIDetections, trustProvenanceEntries, curiositySafeNudges } from '@/mocks/kosCompetencySeeding';
...
export default function KosBigFourQualityGovernancePage() {
