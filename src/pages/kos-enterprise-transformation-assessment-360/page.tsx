...
import { ROADMAP_12M, ROADMAP_24M, ROADMAP_36M } from '@/mocks/kosEnterpriseTransformationAssessment360';
import type { AuditAxe, AuditRiskItem, SWOTItem, PESTELItem } from '@/mocks/kosEnterpriseTransformationAssessment360';
...
export default function KOSEnterpriseTransformationAssessmentPage() {
  const {
  ...
  if (loading) {
    return (
      <KOSHubLayout hubId={83} activeTab="dashboard" tabLabel="ETA 360°">
  ...
  return (
    <KOSHubLayout hubId={83} activeTab={activeTab === 'axe' ? 'axe' : activeTab} tabLabel="ETA 360°">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        {/* ===== HEADER ===== */}
        <div className="mb-8">
