...
import { agentCatalogEntries, securityFrameworkControls, seoAuthorityStandards, clientSuccessPlaybook, maturityModelAssessments } from '@/mocks/kosArtifactsGrowthStrategy';

type Tab = 'agents' | 'security' | 'seo' | 'clientsuccess' | 'maturity';

export default function KOSArtifactsGrowthStrategyPage() {
