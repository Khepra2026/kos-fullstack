...
import type { CorrectiveActionBlock, BlockAction, BlockKPI, BlockReference } from '@/mocks/kosCorrectiveActionBlocks';
import MassCorrectiveActions from './components/MassCorrectiveActions';
...
export default function KOSCorrectiveActionBlocksPage() {
  const {
  ...
  if (loading) {
    return (
      <KOSHubLayout hubId={84} activeTab="dashboard" tabLabel="Blocs Correctifs">
  ...
  return (
    <KOSHubLayout hubId={84} activeTab={activeTab === 'bloc' ? 'bloc' : activeTab} tabLabel="Blocs Correctifs">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        {/* ===== HEADER ===== */}
        <div className="mb-8">
...
import { CORRECTIVE_ACTION_BLOCKS } from '@/mocks/kosCorrectiveActionBlocks';