...
export default function KOSDiagnostic360Page() {
  ...
  return (
    <KOSHubLayout hubId={52} activeTab={activeTab} tabLabel={tabs.find(t => t.id === activeTab)?.label}>
      {/* Header */}
