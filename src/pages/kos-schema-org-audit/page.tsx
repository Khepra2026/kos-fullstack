...
export default function KOSSchemaOrgAuditPage() {
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
              ...
              <StatCard label="Types Déployés" value={summary.total_types_deployed} sub="12/12 actifs" icon="ri-code-s-slash-line" color="bg-accent-500" />
              <StatCard label="Couverture" value={`${summary.schema_coverage_pct}%`} sub={`${summary.total_pages_with_schema}/${summary.total_pages_scanned} pages`} icon="ri-global-line" color="bg-emerald-500" trend="up" />
              <StatCard label="Erreurs" value={summary.validation_errors} sub={`${summary.validation_warnings} warnings`} icon="ri-error-warning-line" color="bg-red-500" />
              <StatCard label="Rich Results" value={summary.rich_results_active} sub={`Cible ${summary.rich_results_target}`} icon="ri-star-line" color="bg-amber-500" trend="up" />
              <StatCard label="Validation" value={`${summary.schema_validator_passed}%`} sub="Schema Markup Validator" icon="ri-check-double-line" color="bg-secondary-500" />
            </div>
