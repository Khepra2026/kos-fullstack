...
import { kosHubs, dashboardMetrics, systemStatus, maturityMetricsReel } from '@/mocks/kosDashboard';
import type { KosHub } from '@/mocks/kosDashboard';
import SystemScanOverlay from './components/SystemScanOverlay';
import TenderWatchWidget from './components/TenderWatchWidget';
import GscGmbQuickWins from '@/components/feature/GscGmbQuickWins';
import KOSAgentsPanel from './components/KOSAgentsPanel';
import BCEAOAlertBanner from './components/BCEAOAlertBanner';
...
export default function KosDashboardPage() {
      ...
      <footer className="border-t border-background-200/70 bg-background-100">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-4">
            <StatCard label="Hubs Actifs" value={dashboardMetrics.activeHubs} icon="ri-radar-line" colorClass="bg-primary-100 text-primary-700" />
            <StatCard label="Modules" value={dashboardMetrics.totalModules} icon="ri-stack-line" colorClass="bg-accent-100 text-accent-700" />
            <StatCard label="Tables" value={dashboardMetrics.totalTables} icon="ri-database-2-line" colorClass="bg-secondary-100 text-secondary-700" />
            <StatCard label="Edge Functions" value={dashboardMetrics.totalEdgeFunctions} icon="ri-function-line" colorClass="bg-primary-100 text-primary-700" />
            <StatCard label="Agents IA" value={dashboardMetrics.totalAgents} icon="ri-robot-2-line" colorClass="bg-accent-100 text-accent-700" />
            <StatCard label="Alertes Actives" value={dashboardMetrics.activeAlerts} icon="ri-alert-line" colorClass="bg-secondary-100 text-secondary-700" />
            <StatCard label="Score Global" value={`${dashboardMetrics.globalHealthScore}/10`} icon="ri-medal-line" colorClass="bg-emerald-100 text-emerald-700" />
          </div>
        </div>
      </footer>
