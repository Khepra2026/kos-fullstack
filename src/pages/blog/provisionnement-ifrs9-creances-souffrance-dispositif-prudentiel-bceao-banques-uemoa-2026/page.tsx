...
const article = ARTICLES_GENERATED.find(a => a.id === 'ifrs9-provisioning-bceao-2026');
...
export default function ArticleIFRS9Provisioning() {
  ...
  return (
    <>
      <SeoHead
        ...
        articleSection="Normes Comptables & Prudentiel Bancaire"
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 text-sm font-bold uppercase tracking-wider" style={{ background: 'rgba(13,123,95,0.2)', border: '1px solid rgba(13,123,95,0.4)', color: '#0D7B5F' }}>
                  <i className="ri-scales-3-line" /> {article.category}
                </div>
