...
import { ARTICLE_10_ALM } from '@/mocks/article10ALMUEMOA';

const article = ARTICLE_10_ALM;
...
export default function ArticleALMUEMOA() {
  ...
  return (
    <>
      <SeoHead
        ...
        ogType="article"
        articlePublishedTime="2026-07-01T08:00:00+00:00"
        articleAuthor="Dr. Abdoulaye Sangaré"
        articleSection="ALM & Trésorerie Bancaire"
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 text-sm font-bold uppercase tracking-wider" style={{ background: 'rgba(5,150,105,0.2)', border: '1px solid rgba(5,150,105,0.4)', color: '#059669' }}>
                  <i className="ri-funds-box-line" /> {article.category}
                </div>
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 py-12">
          ...
          <div className="mt-8">
            <SocialShareWidget
              ...
              hashtags={['ALM', 'TrésorerieBancaire', 'UEMOA', 'BCEAO', 'GestionActifPassif', 'BanqueAfrique']}
            />
          </div>
          ...
          <div className="mt-8 p-5 rounded-2xl bg-background-100 border border-background-200">
            <p className="text-foreground-600 text-xs leading-relaxed">
              <strong>Avertissement :</strong> Cet article est fourni à titre d'analyse et d'information. Les textes réglementaires doivent être consultés dans leur version officielle auprès des autorités compétentes (BCEAO). Khepra Experts ne saurait être tenu responsable des décisions prises sur la seule base de cette analyse.
            </p>
          </div>
        </div>
      </main>
