...
export class KosAuditTrailEngine {
  ...
  getStatistics(): {
    ...
    chainIntegrity: ReturnType<KosAuditTrailEngine['getChainIntegrityReport']>;
  } {
...
export const kosAuditTrailEngine = new KosAuditTrailEngine();