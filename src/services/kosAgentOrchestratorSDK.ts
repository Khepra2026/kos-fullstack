...
export class KOSAgentOrchestrator {
...
let defaultOrchestrator: KOSAgentOrchestrator | null = null;

export function getKOSOrchestrator(userId?: string): KOSAgentOrchestrator {
  if (!defaultOrchestrator) {
    defaultOrchestrator = new KOSAgentOrchestrator(userId);
  }
  return defaultOrchestrator;
}

export function createKOSOrchestrator(userId?: string): KOSAgentOrchestrator {
  return new KOSAgentOrchestrator(userId);
}