...
let gatewayInstance: KosApiGateway | null = null;

export function getApiGateway(config: GatewayConfig): KosApiGateway {
  if (!gatewayInstance) {
    gatewayInstance = new KosApiGateway(config);
  }
  return gatewayInstance;
}

export { KosApiGateway, ROUTING_TABLE, RATE_LIMITS };
export type {
  BackendTarget,
  UserTier,
  RequestCategory,
