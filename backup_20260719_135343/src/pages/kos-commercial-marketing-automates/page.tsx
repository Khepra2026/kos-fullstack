...
import type { commercialMarketingAutomate } from '@/hooks/useCommercialMarketingAutomates';
...
export default function commercialMarketingAutomatesPage() {
            ...
            <>
              ...
              {filteredAutomates.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                  {filteredAutomates.map((automate: commercialMarketingAutomate) => {
