...
import { PRODUCTION_PACKAGES, FACTORY_STATS } from '@/mocks/productionPackageFactory';
import type { ProductionPackage, ScriptSection, VisualCue } from '@/mocks/productionPackageFactory';
...
export default function productionPackageFactoryPage() {
