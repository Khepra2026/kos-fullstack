...
import type { thinkTankAutomate } from '@/hooks/useThinkTankAutomates';
...
export default function thinkTankAutomatesPage() {
            ...
            <>
              ...
              {filteredAutomates.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                  {filteredAutomates.map((automate: thinkTankAutomate) => {
