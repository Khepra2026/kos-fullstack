import { Evidence, RegulatoryIntent, RankingFactors, SourcePriority } from '';
import { regulatoryEvidences } from '';
import { OntoExpansionResult } from '';
...
export const RAGEngine = { id: 1, label: "Stub data" }; // stub
