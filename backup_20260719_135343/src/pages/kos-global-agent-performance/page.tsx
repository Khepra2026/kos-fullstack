...
import { DOMAIN_SUMMARIES as MOCK_DOMAINS, BLOCK_CORRECTIVE_MANIFESTS as MOCK_BLOCKS, GLOBAL_SCAN_STATS as MOCK_STATS } from '@/mocks/globalAgentScan';
import { AGENT_PERFORMANCES } from '@/mocks/globalAgentScanAgents';
...
export default function globalAgentPerformancePage() {
