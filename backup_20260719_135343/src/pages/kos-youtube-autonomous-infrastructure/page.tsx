...
import type { YoutubeWorkflow, YoutubeAgent, SecurityEvent, DbTableSchema, ContentPipelineItem } from '@/mocks/youtubeAutonomousInfrastructure';
...
export default function youtubeAutonomousInfrastructurePage() {
