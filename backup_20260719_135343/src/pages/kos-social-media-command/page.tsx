...
import SocialAutomationPaceDashboard from '';
import SocialUrlHealthPanel from '';
import SocialQualityPanel from '';
import IntelligentOrchestratorPanel from '';
import totalSystemScanPanel from '@/components/totalSystemScanPanel';
import { getOgPreviewUrl } from '@/utils/ogPreview';
import { Link, useSearchParams } from 'react-router-dom';
import GeneratePostPanel from '';
import MetaContentPanel from '';
...
export default function socialMediaCommandPage() {
  ...
  return (
    <hubLayout hubId={28}>
      ...
      />
        ...
        {activeTab === 'scan-total' && <totalSystemScanPanel />}
