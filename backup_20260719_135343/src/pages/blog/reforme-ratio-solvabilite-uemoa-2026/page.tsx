...
export default function ArticleReformeSolvabilite() {
  ...
  return (
    <>
      <SeoHead
        ...
        articleAuthor="Dr. Célestine Koffi"
        articleSection="Régulation Bancaire"
          ...
          <div className="h-[420px] md:h-[540px] w-full bg-cover bg-top relative" style={{ backgroundImage: `url(${article.hero_image_url})` }}>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 text-sm font-bold uppercase tracking-wider" style={{ background: 'rgba(190,18,60,0.2)', border: '1px solid rgba(190,18,60,0.4)', color: '#BE123C' }}>
