...
import { SYSTEM_SCAN_PHASES, SYSTEM_SCAN_SUMMARY, SCAN_QUICK_STATS } from '@/mocks/systemScanResults';
import type { SystemScanPhase, SystemScanFinding } from '@/mocks/systemScanResults';
