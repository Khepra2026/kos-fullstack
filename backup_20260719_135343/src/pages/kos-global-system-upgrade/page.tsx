...
import type { AgentCapabilityGap, AutomateUpgrade, GSCBoosterUrl, LinkedInBlockDiagnostic } from '@/mocks/globalSystemUpgrade';
...
export default function globalSystemUpgradePage() {
