...
import { TRANSFO_DIGITALE_AXES, getTransfoDigitaleScoreColor, getTransfoDigitaleScoreLabel, getTransfoDigitaleLevel, getTransfoDigitaleReadiness, getTransfoDigitaleRisks, getTransfoDigitaleRecommendations } from '';
