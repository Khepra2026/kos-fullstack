...
export const getBenchmarkSectorielScoreColor = { id: 1, label: "Stub data" }; // stub
export const getBenchmarkSectorielScoreLabel = { id: 1, label: "Stub data" }; // stub
export const getBenchmarkSectorielLevel = { id: 1, label: "Stub data" }; // stub
export const getBenchmarkSectorielReadiness = { id: 1, label: "Stub data" }; // stub
export const getBenchmarkSectorielRisks = { id: 1, label: "Stub data" }; // stub
export const getBenchmarkSectorielRecommendations = { id: 1, label: "Stub data" }; // stub
