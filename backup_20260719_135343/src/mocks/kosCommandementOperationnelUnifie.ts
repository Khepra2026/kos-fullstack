...
export interface automateFamily {
  id: string;
  name: string;
  icon: string;
  color: string;
...
export interface unifiedGlobalKPIs {
...
export const KOS_UNIFIED_FAMILIES: automateFamily[] = [
  {
...
export const KOS_UNIFIED_GLOBAL_KPIS: unifiedGlobalKPIs = {
  total_families: 11,
  total_agents: 261,
  deployed: 166,
  partial: 95,
...
export const KOS_OPERATIONAL_CHAIN: operationalChain[] = [
  {
    id: 'phase-1',
    phase: 'Phase 1',
