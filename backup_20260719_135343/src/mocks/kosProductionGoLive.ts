...
export const GO_LIVE_CHECKLIST: GoLiveChecklistItem[] = [
  ...
  { id: 'gl-003', phase: 'Pré-vol', category: 'Tests', task: 'Validation cross-hub — 78/78 hubs StyleSystem conformes', status: 'passed', verifiedBy: 'KOS Hub Validator™', verifiedAt: '2026-06-20T08:59:00Z', notes: 'StyleSystem 100%, hubLayout 100%', critical: true },
