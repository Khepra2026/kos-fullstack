import { BigFourScores, content } from '@/types/kos';

async function checkCoherence(_c: Partial<content>): Promise<number> { return 0.98; }
async function checkLegal(_c: Partial<content>): Promise<boolean> { return true; }
async function checkBrand(_c: Partial<content>): Promise<number> { return 0.97; }
async function checkSEO(_c: Partial<content>): Promise<number> { return 94; }
async function checkReadability(_c: Partial<content>): Promise<number> { return 91; }
async function checkAI(_c: Partial<content>): Promise<number> { return 96; }
async function assessRisk(_c: Partial<content>): Promise<number> { return 0.08; }
...
export function useQualityAgent() {
  const evaluate = async (content: Partial<content>): Promise<BigFourScores> => {
