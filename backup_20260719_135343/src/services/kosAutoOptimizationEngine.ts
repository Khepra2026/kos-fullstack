...
let optimizationEngineInstance: autoOptimizationEngine | null = null;

export function getAutoOptimizationEngine(): autoOptimizationEngine {
  if (!optimizationEngineInstance) {
    optimizationEngineInstance = new autoOptimizationEngine();
  }
