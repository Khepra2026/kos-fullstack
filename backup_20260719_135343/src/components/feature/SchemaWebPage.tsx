...
import publicSchema from '@/components/feature/publicSchema';
...
export default function SchemaWebPage({ name, description, url, inLanguage, breadcrumbs, slug }: SchemaWebPageProps) {
  useEffect(() => {
