...
import { REGULATORY_DOMAINS, REGULATORY_AGENTS, REGULATORY_ALERTS, REGULATORY_GLOBAL_METRICS, type RegulatoryDomain, type RegulatoryAgent, type RegulatoryAlert } from '@/mocks/bloc08RegulatoryExcellence';
