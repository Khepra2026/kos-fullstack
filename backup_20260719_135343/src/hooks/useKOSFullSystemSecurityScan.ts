...
import {
  fullSystemSecurityFindings,
  fullSystemSecurityStats,
} from "@/mocks/fullSystemSecurityScan";
...
interface UseKOSFullSystemSecurityScanReturn {
  findings: typeof fullSystemSecurityFindings;
  stats: typeof fullSystemSecurityStats;
  loading: boolean;
  error: string | null;
...
export function useKOSFullSystemSecurityScan(): UseKOSFullSystemSecurityScanReturn {
  const [findings] = useState(fullSystemSecurityFindings);
  const [stats] = useState(fullSystemSecurityStats);
