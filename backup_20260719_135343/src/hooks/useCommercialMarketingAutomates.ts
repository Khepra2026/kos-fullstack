...
import { KOS_COMMERCIAL_MARKETING_AUTOMATES as mockAutomates, COMMERCIAL_MARKETING_CATEGORIES as mockCategories, COMMERCIAL_MARKETING_KPIS as mockKPIs } from '@/mocks/commercialMarketingAutomates';
import type { commercialMarketingAutomate, CommercialMarketingCategory } from '@/mocks/commercialMarketingAutomates';

export type { commercialMarketingAutomate, CommercialMarketingCategory };
...
export interface CommercialMarketingData {
  automates: commercialMarketingAutomate[];
  categories: CommercialMarketingCategory[];
  kpis: CommercialMarketingKPIs;
  isLive: boolean;
}

function mapAutomate(row: Record<string, unknown>): commercialMarketingAutomate {
  return {
    id: row.id as string,
    ...
    status: row.status as commercialMarketingAutomate['status'],
    ...
    priority: row.priority as commercialMarketingAutomate['priority'],
    kpis: Array.isArray(row.kpis) ? row.kpis as commercialMarketingAutomate['kpis'] : [],
