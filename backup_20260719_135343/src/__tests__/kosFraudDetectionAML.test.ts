...
import { fraudDetectionAMLEngine } from '@/services/fraudDetectionAMLEngine';
...
describe('KOS Fraud Detection & AML Engine — Transaction Screening', () => {
  let engine: fraudDetectionAMLEngine;

  beforeEach(() => {
    engine = new fraudDetectionAMLEngine();
  });
...
describe('KOS Fraud Detection & AML Engine — Integral State', () => {
  it('should return engine state for inspection', () => {
    const engine = new fraudDetectionAMLEngine();
